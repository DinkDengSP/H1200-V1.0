...
//网口指令消息处理函数
extern void ModMsgNet8700DemoCmd(void* net8700CmdRecvPtr);
//网口上传消息处理函数
extern void ModMsgNet8700DemoUpload(void* net8700ReportDataPtr);
//CAN1指令消息处理函数
extern void ModMsgCan1DemoCmd(void* can1CmdRecvPtr);
//CAN1上传消息处理函数
extern void ModMsgCan1DemoUpload(void* can1ReportDataPtr);
//CAN2指令消息处理函数
extern void ModMsgCan2DemoCmd(void* can2CmdRecvPtr);
//CAN2上传消息处理函数
extern void ModMsgCan2DemoUpload(void* can2ReportDataPtr);
//串口指令消息处理函数
extern void ModMsgUartDemoCmd(void* uartCmdRecvPtr);
//串口上传消息处理函数
extern void ModMsgUartDemoUpload(void* uartReportDataPtr);
//IPC指令消息处理函数
extern void ModMsgIpcDemoCmd(void* ipcCmdRecvPtr);
//IPC上传消息处理函数
extern void ModMsgIpcDemoUpload(void* ipcReportDataPtr);
...
void ModImplDemoMsgProcess(void* taskMsgPtr)
{
    ...
    if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_NET_CMD)
    {
        ...
        {
            //调用网口消息处理函数
            ModMsgNet8700DemoCmd(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_NET_UPLOAD)
    {
        ...
        {
            //调用网口消息处理函数
            ModMsgNet8700DemoUpload(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_CAN1_CMD)
    {
        ...
        {
            //调用CAN1消息处理函数
            ModMsgCan1DemoCmd(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_CAN1_UPLOAD)
    {
        ...
        {
            //调用CAN1消息处理函数
            ModMsgCan1DemoUpload(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_CAN2_CMD)
    {
        ...
        {
            //调用CAN2消息处理函数
            ModMsgCan2DemoCmd(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_CAN2_UPLOAD)
    {
        ...
        {
            //调用CAN2消息处理函数
            ModMsgCan2DemoUpload(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_UART_CMD)
    {
        ...
        {
            //调用串口消息处理函数
            ModMsgUartDemoCmd(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_UART_UPLOAD)
    {
        ...
        {
            //调用串口消息处理函数
            ModMsgUartDemoUpload(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_IPC_CMD)
    {
        ...
        {
            //调用IPC指令处理函数
            ModMsgIpcDemoCmd(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_IPC_UPLOAD)
    {
        ...
        {
            //调用IPC上传消息处理函数
            ModMsgIpcDemoUpload(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
