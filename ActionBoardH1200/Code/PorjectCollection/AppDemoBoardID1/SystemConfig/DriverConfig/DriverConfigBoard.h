 ...
 ** description  : 
 ** LastEditors  : 邓小俊
 ** LastEditTime : 2024-01-23 13:52:08
...
/*---------------------------------------------------板卡FPGA配置----------------------------------------------------------*/
//地址建立时间
#define BOARD_FPGA_ADDRESS_SETUP_CYCLE                          0X0B
//数据保存时间  
#define BOARD_FPGA_DATA_SETUP_CYCLE                             0X0B
//FPGA电机主频
#define BOARD_FPGA_STEP_MOTOR_FREQ                              (60000000)//60M
//FPGA写入地址
#define BOARD_FPGA_BASE_ADDR                                    ((uint32_t)(0X60000000))	
//FSMC ID
#define BOARD_FPGA_CHIP_ID                                      0X19891121
//FSMC 版本号
#define BOARD_FPGA_SOFT_VERSION                                 0X00010002
//写入等待最长等待时间
#define BOARD_FPGA_WRITE_WAIT_CYCLE_MAX                         20
//表预写入长度,因为写表时间比较长,使用预写入功能可以让电机先动起来,防止电机失速
#define BOARD_FPGA_WRITE_TAB_PRE_LEN                            5
//支持的输入端口最大数量
#define BOARD_FPGA_PORT_IN_MAX                                  4
//输入端口A的有效输入数量
#define BOARD_FPGA_IN_PORT_PIN_MAX                              32
//支持的输出端口最大数量
#define BOARD_FPGA_PORT_OUT_MAX                                 4
//输出端口A的有效输出数量
#define BOARD_FPGA_OUT_PORT_PIN_MAX                             32
//步进电机有效数量配置
#define BOARD_FPGA_STEP_MOTOR_NUM_MAX                           16
//步进电机表长度
#define BOARD_FPGA_STEP_MOTOR_TAB_LENGTH                        1024
//FPGA中断线0
#define BOARD_FPGA_INT0_PIN                                     MCU_PIN_G_7
//FPGA中断线1
#define BOARD_FPGA_INT1_PIN                                     MCU_PIN_A_8
//FPGA中断线2
#define BOARD_FPGA_INT2_PIN                                     MCU_PIN_A_11
//FPGA中断线3
#define BOARD_FPGA_INT3_PIN                                     MCU_PIN_D_2
//中断模式
#define BOARD_FPGA_INT_TRIG_MODE                                GPIO_MODE_IT_RISING
//复位引脚
#define BOARD_FPGA_TRST_PIN                                     MCU_PIN_C_9
//有效电平
#define VALID_LEVEL_BOARD_FPGA_TRST                             GPIO_PIN_RESET
//配置完成信号
#define BOARD_FPGA_CONFIG_DONE_PIN                              MCU_PIN_C_8
//有效电平
#define VALID_LEVEL_BOARD_FPGA_CONFIG_DONE                      GPIO_PIN_SET
//配置信号
#define BOARD_FPGA_N_CONFIG_PIN                                 MCU_PIN_G_6
//有效电平
#define VALID_LEVEL_BOARD_FPGA_N_CONFIG                         GPIO_PIN_SET
//状态讯号
#define BOARD_FPGA_N_STATUS_PIN                                 MCU_PIN_D_13
//有效电平
#define VALID_LEVEL_BOARD_FPGA_N_STATUS                         GPIO_PIN_SET
//FPGA数据清空讯号
#define BOARD_FPGA_CLRN_PIN                                     MCU_PIN_A_12
//有效电平
#define VALID_LEVEL_BOARD_FPGA_CLRN_PIN                         GPIO_PIN_SET
//中断锁定
#define BOARD_FPGA_LOCK()                                       uint32_t lastIntState = CoreLockIntGlobal()
//中断解锁
#define BOARD_FPGA_UNLOCK(lastIntState)                         CoreUnlockIntGlobal(lastIntState)
/*-----------------------------------------------------------板上CAN1管理---------------------------------------------*/
