 ...
 ** description  : 
 ** LastEditors  : 邓小俊
 ** LastEditTime : 2024-01-31 16:04:16
...
#error "Lib FDCAN Must Use CallBack FuncPtr !!!"
#endif
...
//总线关闭的最长等待时间
#define MCU_CAN1_WAIT_BUS_OFF_SYNC_TIME_MS      100
//自动重发配置
...
//是否需要配置29位扩展帧过滤器
#define MCU_CAN1_EXT_FILTER_NBR_EXIST           CONFIG_FUNC_ENABLE
...
#endif
//至少配置一个过滤器
#if((MCU_CAN1_STD_FILTER_NBR_EXIST == CONFIG_FUNC_DISABLE)&&(MCU_CAN1_EXT_FILTER_NBR_EXIST == CONFIG_FUNC_DISABLE))
...
//总线关闭的最长等待时间
#define MCU_CAN2_WAIT_BUS_OFF_SYNC_TIME_MS      100
//自动重发配置
...
//是否需要配置29位扩展帧过滤器
#define MCU_CAN2_EXT_FILTER_NBR_EXIST           CONFIG_FUNC_ENABLE
...
#endif
//至少配置一个过滤器
#if((MCU_CAN2_STD_FILTER_NBR_EXIST == CONFIG_FUNC_DISABLE)&&(MCU_CAN2_EXT_FILTER_NBR_EXIST == CONFIG_FUNC_DISABLE))
