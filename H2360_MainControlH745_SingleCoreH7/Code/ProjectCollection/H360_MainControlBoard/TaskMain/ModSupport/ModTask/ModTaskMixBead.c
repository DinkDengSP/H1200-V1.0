...
//任务的控制块
TX_THREAD tcbModTaskMixBead@".dtcm_ram";
//任务堆栈
uint64_t stackBufferModTaskMixBead[STK_SIZE_MOD_TASK_MIX_BEAD/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueModTaskMixBead@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferModTaskMixBead[LENGTH_QUEUE_MOD_TASK_MIX_BEAD]@".dtcm_ram";
