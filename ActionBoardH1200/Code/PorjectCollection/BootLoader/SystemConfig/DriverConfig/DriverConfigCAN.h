...
/*----------------------------------------芯片CAN1配置讯息--------------------------------------*/
//端口配置
#define MCU_CAN1_TX_PIN                         MCU_PIN_H_13
#define MCU_CAN1_RX_PIN                         MCU_PIN_H_14
//使用CAN1,会占用USB FS的DP引脚,所以USB和CAN1不能同时使用
//使用CAN1,会占用USB FS的DM引脚,所以USB和CAN1不能同时使用
//设置CAN1模式
#define MCU_CAN1_MODE_USER                      MCU_CAN_MODE_CLASSICAL
//是否显示中断回调讯息
#define MCU_CAN1_ENANLE_SHOW_INT_MSG            CONFIG_FUNC_DISABLE
