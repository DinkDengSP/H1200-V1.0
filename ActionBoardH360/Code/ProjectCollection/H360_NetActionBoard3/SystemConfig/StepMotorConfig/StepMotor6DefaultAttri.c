...
** LastEditTime  : 2023-12-13 10:17:16 +0800
************************************************************************************************/ 
#include "StepMotorParam.h"
//步进电机6:  B液注射泵-柱塞泵(描述电机名称)
//步进电机默认配置
const STEP_MOTOR_ATTRIBUTE StepMotor6DefaultAttri = {
    ...
    //基础配置
    {
        ...
        16000,//uint32_t resetMaxSteps;电机复位最大行程
        ...
        250.0f,//float resetSpeedFast;复位速度,快速,主要用在找原点
        100.0f,//float resetSpeedSlow;复位速度,慢速,主要用在脱离原点和二次回到原点
    ...
    //速度表配置,每个电机带六个速度表
    {
        ...
        //速度曲线12,注液速度
        {
            ...
            0.125f,//accOfAcc加加速(加速度的加速度)
            4.0f,//maxAcc 最大加速度
            725.0f,//maxSpeed 最大速度
        },
        //速度曲线13, 吸液速度
        {
            SAME_TIME_FRAME,//STEP_MODE stepMode;步数适配模式,等步数或者等时间帧
            2,//uint32_t startStep;启动步数设定
            118.75f,//startSpeed 启动速度设定
            0.0f,//startAcc启动加速度
            0.125f,//accOfAcc加加速(加速度的加速度)
            3.75f,//maxAcc 最大加速度
