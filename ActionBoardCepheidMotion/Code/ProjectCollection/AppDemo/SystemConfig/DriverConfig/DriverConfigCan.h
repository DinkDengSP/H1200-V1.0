...
** LastEditTime  : 2023-10-30 11:06:08 +0800
************************************************************************************************/ 
...
#define MCU_CAN1_WAIT_FIFO_SINGLE_PACK_MS               30
//CAN总线离线之后等待再次上线的时间
#define MCU_CAN1_WAIT_BUS_OFF_TIME_MS                   200
...
//等待CAN FIFO最长时间,数据发包的时候如果超时还没有缓冲区就认为是异常
#define MCU_CAN2_WAIT_FIFO_SINGLE_PACK_MS               30
//CAN总线离线之后等待再次上线的时间
#define MCU_CAN2_WAIT_BUS_OFF_TIME_MS                   200
