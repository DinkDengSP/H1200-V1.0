...
** LastEditTime  : 2023-11-06 15:39:39 +0800
************************************************************************************************/ 
...
//存放在线升级BOOT文件的起始地址
#define ADDR_BOARD_IAP_BOOT_BIN_FILE_START              MCU_FLASH_SRV_BOOT_BACK_UP
#define LENGTH_BOARD_IAP_BOOT_BIN_FILE                  (256*1024)

//存放在线升级SRV文件的起始地址
#define ADDR_BOARD_IAP_SRV_BIN_FILE_START               MCU_FLASH_SRV_MAIN_BACK_UP
#define LENGTH_BOARD_IAP_SRV_BIN_FILE                   (768*1024)

//存放在线升级APP文件的起始地址
#define ADDR_BOARD_IAP_APP_BIN_FILE_START               MCU_FLASH_SRV_MAIN_BACK_UP
