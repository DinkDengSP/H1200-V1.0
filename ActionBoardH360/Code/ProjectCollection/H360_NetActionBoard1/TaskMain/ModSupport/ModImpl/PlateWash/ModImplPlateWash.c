...
** LastEditTime  : 2023-11-26 23:51:53 +0800
************************************************************************************************/ 
...
//CAN1指令消息处理函数
extern void ModMsgCan1PlateWashCmd(void* can1CmdRecvPtr);
//CAN1上传消息处理函数
extern void ModMsgCan1PlateWashUpload(void* can1ReportDataPtr);
//IPC指令消息处理函数
extern void ModMsgIpcPlateWashCmd(void* ipcCmdRecvPtr);
//IPC上传消息处理函数
extern void ModMsgIpcPlateWashUpload(void* ipcReportDataPtr);
