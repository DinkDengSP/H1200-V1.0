 ...
 ** description  : 
 ** LastEditors  : 邓小俊
 ** LastEditTime : 2024-01-16 13:09:57
...
#endif
//定义串口发送方法
#define MCU_UART3_TX_FUNC_USER                          MCU_UART_TX_FUNC_DMA
//定义串口接收方法
#define MCU_UART3_RX_FUNC_USER                          MCU_UART_RX_FUNC_DMA
//发送方法定义,1为同步发送,发送必须等待完成 0为异步发送,写到缓冲区里面自动发送
#define UART3_TRANS_FUNC_SYNC                           CONFIG_FUNC_DISABLE
//等待时间,9600下,单字节发送最长时间也不到2MS
...
//是否打开一个采样位方法,打开的话,将禁止噪声检测标记
#define MCU_UART3_ONE_BIT_SAMPLE                        UART_ONE_BIT_SAMPLE_ENABLE
//过采样模式设定,8位速度更快,16位对波特率的兼容性更好
#define MCU_UART3_OVERSAMPLING_MODE                     UART_OVERSAMPLING_16
//是否关闭ORE过载
#define MCU_UART3_DISABLE_ORE                           CONFIG_FUNC_ENABLE
...
//串口用于接收的BLOCK的每一个的长度     
#define LENGTH_UART3_RECV_SINGLE_BLOCK                  1024

//发送DMA各项配置映射
#define MCU_UART3_DMA_TX_CLK_ENABLE()                   __HAL_RCC_DMA1_CLK_ENABLE()
#define MCU_UART3_DMA_TX_INSTANCE                       DMA1_Stream2
#define MCU_UART3_DMA_TX_PRIORITY                       DMA_PRIORITY_LOW
#define MCU_UART3_DMA_TX_IRQ                            DMA1_Stream2_IRQn
#define MCU_UART3_DMA_TX_IRQ_HANDLER                    DMA1_Stream2_IRQHandler

//接收DMA的各项配置 
#define MCU_UART3_DMA_RX_CLK_ENABLE()                   __HAL_RCC_DMA1_CLK_ENABLE()
#define MCU_UART3_DMA_RX_INSTANCE                       DMA1_Stream3
#define MCU_UART3_DMA_RX_PRIORITY                       DMA_PRIORITY_MEDIUM
#define MCU_UART3_DMA_RX_IRQ                            DMA1_Stream3_IRQn
#define MCU_UART3_DMA_RX_IRQ_HANDLER                    DMA1_Stream3_IRQHandler
...
#define MCU_UART6_DMA_TX_INSTANCE                       DMA1_Stream4
#define MCU_UART6_DMA_TX_PRIORITY                       DMA_PRIORITY_LOW
#define MCU_UART6_DMA_TX_IRQ                            DMA1_Stream4_IRQn
#define MCU_UART6_DMA_TX_IRQ_HANDLER                    DMA1_Stream4_IRQHandler

//接收DMA的各项配置 
#define MCU_UART6_DMA_RX_CLK_ENABLE()                   __HAL_RCC_DMA1_CLK_ENABLE()
#define MCU_UART6_DMA_RX_INSTANCE                       DMA1_Stream5
#define MCU_UART6_DMA_RX_PRIORITY                       DMA_PRIORITY_MEDIUM
#define MCU_UART6_DMA_RX_IRQ                            DMA1_Stream5_IRQn
#define MCU_UART6_DMA_RX_IRQ_HANDLER                    DMA1_Stream5_IRQHandler
