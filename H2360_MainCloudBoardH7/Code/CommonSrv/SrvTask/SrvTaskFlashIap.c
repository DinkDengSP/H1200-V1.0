...
** LastEditTime  : 2023-11-06 14:34:49 +0800
************************************************************************************************/ 
#include "CommonSrvTaskHeader.h"
#include "SrvImplFlashIap.h"

//任务的控制块
TX_THREAD tcbSrvTaskFlashIap@".dtcm_ram";
//任务堆栈
uint64_t stackBufferSrvTaskFlashIap[STK_SIZE_SRV_TASK_FLASH_IAP/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueSrvTaskFlashIap@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferSrvTaskFlashIap[LENGTH_QUEUE_SRV_TASK_FLASH_IAP]@".dtcm_ram";
