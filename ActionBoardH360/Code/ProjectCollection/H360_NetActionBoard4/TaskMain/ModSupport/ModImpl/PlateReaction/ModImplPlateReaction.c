...
//CAN1指令消息处理函数
extern void ModMsgCan1PlateReactionCmd(void* can1CmdRecvPtr);
//CAN1上传消息处理函数
extern void ModMsgCan1PlateReactionUpload(void* can1ReportDataPtr);
//IPC指令消息处理函数
extern void ModMsgIpcPlateReactionCmd(void* ipcCmdRecvPtr);
//IPC上传消息处理函数
extern void ModMsgIpcPlateReactionUpload(void* ipcReportDataPtr);
