...
** LastEditTime  : 2023-12-04 16:04:44 +0800
************************************************************************************************/ 
#include "StepMotorParam.h"
//步进电机6:  清洗针吸废液蠕动泵(描述电机名称)
//步进电机默认配置
const STEP_MOTOR_ATTRIBUTE StepMotor6DefaultAttri = {
    ...
    //基础配置
    {
        ...
        25,//float resetSpeedFast;复位速度,快速,主要用在找原点
        10,//float resetSpeedSlow;复位速度,慢速,主要用在脱离原点和二次回到原点
    ...
    //速度表配置,每个电机带六个速度表
    {
        ...
        {   
            ...
            24.0f,//startSpeed 启动速度设定
            0.0f,//startAcc启动加速度
            0.0625f,//accOfAcc加加速(加速度的加速度)
            1.25f,//maxAcc 最大加速度
            72.0f,//maxSpeed 最大速度
        },
