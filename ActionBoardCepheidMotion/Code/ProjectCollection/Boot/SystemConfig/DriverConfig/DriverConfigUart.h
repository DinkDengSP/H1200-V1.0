...
** LastEditTime  : 2023-10-30 15:34:36 +0800
************************************************************************************************/ 
...
//TX引脚定义
#define UART2_PIN_TX                                    MCU_PIN_A_2
//串口用于printf的缓冲区的长度  
...
//RX引脚定义
#define UART2_PIN_RX                                    MCU_PIN_A_3
//串口用于接收的BLOCK数量   
...
//TX引脚定义
#define UART3_PIN_TX                                    MCU_PIN_C_10
//串口用于printf的缓冲区的长度  
...
//RX引脚定义
#define UART3_PIN_RX                                    MCU_PIN_C_11
//串口用于接收的BLOCK数量   
...
/*--------------------------------------------------串口4-----------------------------------------------------*/
//用户选定的串口模式
#define MCU_UART4_TRANS_MODE_USER                       MCU_UART_TRANS_MODE_TXRX
//定义串口模式
#if(MCU_UART4_TRANS_MODE_USER == MCU_UART_TRANS_MODE_TX)
#define MCU_UART4_TRANS_MODE                            UART_MODE_TX
#elif(MCU_UART4_TRANS_MODE_USER == MCU_UART_TRANS_MODE_RX)
#define MCU_UART4_TRANS_MODE                            UART_MODE_RX
#elif(MCU_UART4_TRANS_MODE_USER == MCU_UART_TRANS_MODE_TXRX)
#define MCU_UART4_TRANS_MODE                            UART_MODE_TX_RX
#endif
//定义串口发送方法
#define MCU_UART4_TX_FUNC_USER                          MCU_UART_TX_FUNC_INT
//定义串口接收方法
#define MCU_UART4_RX_FUNC_USER                          MCU_UART_RX_FUNC_DMA
//发送方法定义,1为同步发送,发送必须等待完成 0为异步发送,写到缓冲区里面自动发送
#define UART4_TRANS_FUNC_SYNC                           0
//等待时间,9600下,单字节发送最长时间也不到2MS
#define MCU_UART4_SINGLE_BYTE_TRANS_TIME_MS_MAX         2
//串口传输指定长度数据的最长等待时间
#define MCU_UART4_WAIT_TRANS_MAX(bufferByteMax)         (MCU_UART4_SINGLE_BYTE_TRANS_TIME_MS_MAX*(bufferByteMax))

//TX引脚定义
#define UART4_PIN_TX                                    MCU_PIN_A_0
//串口用于printf的缓冲区的长度  
#define LENGTH_UART4_BUFFER_WITH_FORMAT                 1024
//发送数据的串口缓冲区的长度    
#define LENGTH_UART4_BUFFER_WITH_SEND                   1024
//使用DMA单块发送数据,单块的长度    
#define LENGTH_UART4_BUFFER_WITH_BLOCK                  256

//RX引脚定义
#define UART4_PIN_RX                                    MCU_PIN_A_1
//串口用于接收的BLOCK数量   
#define COUNT_UART4_RECV_BLOCK                          8
//串口用于接收的BLOCK的每一个的长度 
#define LENGTH_UART4_RECV_SINGLE_BLOCK                  256

#if(MCU_UART4_TX_FUNC_USER == MCU_UART_TX_FUNC_DMA)
//发送DMA各项配置映射,
#define MCU_UART4_DMA_TX_CLK_ENABLE()                   __HAL_RCC_DMA1_CLK_ENABLE()
#define MCU_UART4_DMA_TX_INSTANCE                       DMA1_Stream4
#define MCU_UART4_DMA_TX_CHANNEL                        DMA_CHANNEL_4
#define MCU_UART4_DMA_TX_PRIORITY                       DMA_PRIORITY_LOW
#define MCU_UART4_DMA_TX_IRQ                            DMA1_Stream4_IRQn
#define MCU_UART4_DMA_TX_IRQ_HANDLER                    DMA1_Stream4_IRQHandler
#endif

#if(MCU_UART4_RX_FUNC_USER == MCU_UART_RX_FUNC_DMA)
//接收DMA的各项配置 只有DMA1_STREAM1可选
#define MCU_UART4_DMA_RX_CLK_ENABLE()                   __HAL_RCC_DMA1_CLK_ENABLE()
#define MCU_UART4_DMA_RX_INSTANCE                       DMA1_Stream2
#define MCU_UART4_DMA_RX_CHANNEL                        DMA_CHANNEL_4
#define MCU_UART4_DMA_RX_PRIORITY                       DMA_PRIORITY_HIGH
#define MCU_UART4_DMA_RX_IRQ                            DMA1_Stream2_IRQn
#define MCU_UART4_DMA_RX_IRQ_HANDLER                    DMA1_Stream2_IRQHandler
#endif

//错误配置报警,防止用户配错模式导致程序异常
#if(MCU_UART4_TRANS_MODE_USER == MCU_UART_TRANS_MODE_TX)&&(MCU_UART4_RX_FUNC_USER != MCU_UART_RX_FUNC_NONE)
//只定义了发送,但是却定义了接收模式,错误,接受模式应该是 MCU_UART_RX_FUNC_NONE
#error "MCU_UART4 Only Define TX,Should Not Define RX USER Func"
#endif
#if(MCU_UART4_TRANS_MODE_USER == MCU_UART_TRANS_MODE_RX)&&(MCU_UART4_TX_FUNC_USER != MCU_UART_TX_FUNC_NONE)
//只定义了接收,但是却定义了发送模式,错误,发送模式应该是 MCU_UART_TX_FUNC_NONE
#error "MCU_UART4 Only Define RX,Should Not Define TX USER Func"
#endif
#if(MCU_UART4_TRANS_MODE_USER == MCU_UART_TRANS_MODE_RX)&&(MCU_UART4_RX_FUNC_USER == MCU_UART_RX_FUNC_NONE)
//定义了接收,却没有定义接收方法
#error "MCU_UART4 Define RX,Should Define RX USER Func"
#endif
#if(MCU_UART4_TRANS_MODE_USER == MCU_UART_TRANS_MODE_TX)&&(MCU_UART4_TX_FUNC_USER == MCU_UART_TX_FUNC_NONE)
//定义了发送,却没有定义发送方法
#error "MCU_UART4 Define TX,Should Define TX USER Func"
#endif
#if(MCU_UART4_TRANS_MODE_USER == MCU_UART_TRANS_MODE_TXRX)&&(MCU_UART4_RX_FUNC_USER == MCU_UART_RX_FUNC_NONE)
//定义了发送接收,却没有定义接收方法
#error "MCU_UART4 Define TXRX,Should Define RX USER Func"
#endif
#if(MCU_UART4_TRANS_MODE_USER == MCU_UART_TRANS_MODE_TXRX)&&(MCU_UART4_TX_FUNC_USER == MCU_UART_TX_FUNC_NONE)
//定义了发送接收,却没有定义发送方法
#error "MCU_UART4 Define TXRX,Should Define TX USER Func"
#endif
...
//串口用于接收的BLOCK的每一个的长度 
#define LENGTH_UART6_RECV_SINGLE_BLOCK                  256

#if(MCU_UART6_TX_FUNC_USER == MCU_UART_TX_FUNC_DMA)
//发送DMA各项配置映射,
#define MCU_UART6_DMA_TX_CLK_ENABLE()                   __HAL_RCC_DMA2_CLK_ENABLE()
#define MCU_UART6_DMA_TX_INSTANCE                       DMA2_Stream6
#define MCU_UART6_DMA_TX_CHANNEL                        DMA_CHANNEL_5
#define MCU_UART6_DMA_TX_PRIORITY                       DMA_PRIORITY_LOW
#define MCU_UART6_DMA_TX_IRQ                            DMA2_Stream6_IRQn
#define MCU_UART6_DMA_TX_IRQ_HANDLER                    DMA2_Stream6_IRQHandler
#endif

#if(MCU_UART6_RX_FUNC_USER == MCU_UART_RX_FUNC_DMA)
//接收DMA的各项配置 只有DMA1_STREAM1可选
#define MCU_UART6_DMA_RX_CLK_ENABLE()                   __HAL_RCC_DMA2_CLK_ENABLE()
#define MCU_UART6_DMA_RX_INSTANCE                       DMA2_Stream1
#define MCU_UART6_DMA_RX_CHANNEL                        DMA_CHANNEL_5
#define MCU_UART6_DMA_RX_PRIORITY                       DMA_PRIORITY_HIGH
#define MCU_UART6_DMA_RX_IRQ                            DMA2_Stream1_IRQn
#define MCU_UART6_DMA_RX_IRQ_HANDLER                    DMA2_Stream1_IRQHandler
#endif
