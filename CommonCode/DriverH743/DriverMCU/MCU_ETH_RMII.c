...
** LastEditTime  : 2023-11-06 17:20:51 +0800
************************************************************************************************/ 
#include "MCU_ETH.h"
#include "MCU_PIN.h"
...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef *heth)
{
    if(heth->Instance == ETH)
    {
        ...
        //端口状态复位
         MCU_PinDeInit(MCU_ETH_RMII_REF_CLK);
        MCU_PinDeInit(MCU_ETH_RMII_MDC);
        MCU_PinDeInit(MCU_ETH_RMII_MDIO);
        MCU_PinDeInit(MCU_ETH_RMII_CRS_DV);
        MCU_PinDeInit(MCU_ETH_RMII_RXD0);
        MCU_PinDeInit(MCU_ETH_RMII_RXD1);
        MCU_PinDeInit(MCU_ETH_RMII_TXEN);
        MCU_PinDeInit(MCU_ETH_RMII_TXD0);
        MCU_PinDeInit(MCU_ETH_RMII_TXD1);
        //关闭ETH中断
...
{ 
    if(heth->Instance == ETH)
    {
        ...
        //端口初始化
        MCU_PinInit(MCU_ETH_RMII_REF_CLK,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_MEDIUM,GPIO_AF11_ETH);
        MCU_PinInit(MCU_ETH_RMII_MDC,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_MEDIUM,GPIO_AF11_ETH);
        MCU_PinInit(MCU_ETH_RMII_MDIO,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_MEDIUM,GPIO_AF11_ETH);
        MCU_PinInit(MCU_ETH_RMII_CRS_DV,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_MEDIUM,GPIO_AF11_ETH);
        MCU_PinInit(MCU_ETH_RMII_RXD0,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_MEDIUM,GPIO_AF11_ETH);
        MCU_PinInit(MCU_ETH_RMII_RXD1,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_MEDIUM,GPIO_AF11_ETH);
        MCU_PinInit(MCU_ETH_RMII_TXEN,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_MEDIUM,GPIO_AF11_ETH);
        MCU_PinInit(MCU_ETH_RMII_TXD0,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_MEDIUM,GPIO_AF11_ETH);
        MCU_PinInit(MCU_ETH_RMII_TXD1,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_MEDIUM,GPIO_AF11_ETH);
        //清除中断标记
