...
** LastEditTime  : 2023-11-13 16:39:51 +0800
************************************************************************************************/ 
...
/*-----------------------------------------------------------MCU内存管理长度-----------------------------------------*/
#define MEM_MANAGE_BYTE_SIZE_SRAM_IN                    70*1024
...
#define SPI1_DMA_RX_INSTANCE                            DMA2_Stream0                   
...
#define SPI1_DMA_RX_IRQ_HANDLER                         DMA2_Stream0_IRQHandler        
#endif
