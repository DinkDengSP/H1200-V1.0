...
//联机
static void SrvMsgUartUtilCmd_OnLine(UART_PROT_CMD_PACK_RECV* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//脱机
static void SrvMsgUartUtilCmd_OffLine(UART_PROT_CMD_PACK_RECV* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//UTC同步
static void SrvMsgUartUtilCmd_UtcSync(UART_PROT_CMD_PACK_RECV* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//心跳获取
static void SrvMsgUartUtilCmd_HeartGet(UART_PROT_CMD_PACK_RECV* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//急停
static void SrvMsgUartUtilCmd_EmStop(UART_PROT_CMD_PACK_RECV* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//获取版本号
static void SrvMsgUartUtilCmd_GetVersion(UART_PROT_CMD_PACK_RECV* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
...
static const USER_UART_CMD_PROC_UNIT uartCmdProcUtilUnitArray[] = 
{
    ...
    {(uint32_t)UART_MASTER_CMD_MAIN_UTIL_ONLINE         ,1  ,ENABLE ,SrvMsgUartUtilCmd_OnLine       },
    {(uint32_t)UART_MASTER_CMD_MAIN_UTIL_OFFLINE        ,1  ,ENABLE ,SrvMsgUartUtilCmd_OffLine      },
    {(uint32_t)UART_MASTER_CMD_MAIN_UTIL_UTC_SYNC       ,8  ,ENABLE ,SrvMsgUartUtilCmd_UtcSync      },
    {(uint32_t)UART_MASTER_CMD_MAIN_UTIL_HEART_GET      ,0  ,ENABLE ,SrvMsgUartUtilCmd_HeartGet     },
    {(uint32_t)UART_MASTER_CMD_MAIN_UTIL_EM_STOP        ,0  ,ENABLE ,SrvMsgUartUtilCmd_EmStop       },
    {(uint32_t)UART_MASTER_CMD_MAIN_UTIL_GET_VERSION    ,0  ,ENABLE ,SrvMsgUartUtilCmd_GetVersion   },
};
