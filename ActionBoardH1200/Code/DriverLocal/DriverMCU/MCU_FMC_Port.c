...
void MCU_FMC_PortInit(void)
{
    ...
    //PD3 <------> FMC_CLK
    MCU_PinInit(MCU_PIN_D_3,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_VERY_HIGH,GPIO_AF12_FMC);
    //PD4 <------> FMC_NOE 
    ...
    //PD6 <------> FMC_NWAIT
    MCU_PinInit(MCU_PIN_D_6,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_VERY_HIGH,GPIO_AF12_FMC);
    //PG8  <-> FMC_SDCLK
    ...
    //PB4  <-> FMC_NADV
    MCU_PinInit(MCU_PIN_B_4,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_VERY_HIGH,GPIO_AF12_FMC);
    //PD7  <-> FMC_NE1
    MCU_PinInit(MCU_PIN_D_7,MCU_PIN_MODE_AF_PP,MCU_PIN_PULL_PULLUP,MCU_PIN_SPEED_FREQ_VERY_HIGH,GPIO_AF12_FMC);    
...
void MCU_FMC_PortDeInit(void)
{
    ...
    //PD3 <------> FMC_CLK
    MCU_PinDeInit(MCU_PIN_D_3);
    //PD4 <------> FMC_NOE 
    MCU_PinDeInit(MCU_PIN_D_4);
    //PD5 <------> FMC_NWE 
    MCU_PinDeInit(MCU_PIN_D_5);
    //PD6 <------> FMC_NWAIT
    MCU_PinDeInit(MCU_PIN_D_6);
    //PG8  <-> FMC_SDCLK
    ...
    //PB4  <-> FMC_NADV
    MCU_PinDeInit(MCU_PIN_B_4);
    //PD7  <-> FMC_NE1
    MCU_PinDeInit(MCU_PIN_D_7);    
