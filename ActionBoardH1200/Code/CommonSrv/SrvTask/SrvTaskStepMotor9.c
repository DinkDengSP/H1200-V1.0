...
//任务的控制块
TX_THREAD tcbSrvTaskStepMotor9@".dtcm_ram";
//任务堆栈
uint64_t stackBufferSrvTaskStepMotor9[STK_SIZE_SRV_TASK_STEP_MOTOR9/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueSrvTaskStepMotor9@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferSrvTaskStepMotor9[LENGTH_QUEUE_SRV_TASK_STEP_MOTOR9]@".dtcm_ram";
