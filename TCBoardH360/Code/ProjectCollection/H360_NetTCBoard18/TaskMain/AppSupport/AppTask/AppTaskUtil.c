...
** LastEditTime  : 2023-11-13 12:15:16 +0800
************************************************************************************************/ 
#include "TaskConfigApp.h"
#include "AppImplUtil.h"

//任务的控制块
TX_THREAD tcbAppTaskUtil@".ccram";
//任务堆栈
uint64_t stackBufferAppTaskUtil[STK_SIZE_APP_TASK_UTIL/8]@".ccram";
//任务消息队列控制块
TX_QUEUE queueAppTaskUtil@".ccram";
//消息缓冲区
uint32_t queueBufferAppTaskUtil[LENGTH_QUEUE_APP_TASK_UTIL]@".ccram";
