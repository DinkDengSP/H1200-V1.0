...
//网口指令消息处理函数
extern void SrvMsgNet8700DemoCmd(void* net8700CmdRecvPtr);
//网口上传消息处理函数
extern void SrvMsgNet8700DemoUpload(void* net8700ReportDataPtr);
//CAN1指令消息处理函数
...
void SrvImplDemoMsgProcess(void* taskMsgPtr)
{
    ...
    if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_NET_CMD)
    {
        ...
        {
            //调用网口消息处理函数
            SrvMsgNet8700DemoCmd(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
    ...
    else if(sysMsgPtr->msgSrc == SYS_MSG_PACK_SRC_NET_UPLOAD)
    {
        ...
        {
            //调用网口消息处理函数
            SrvMsgNet8700DemoUpload(sysMsgPtr->msgBodyPtr);
        }
        else 
        {
            //报警,消息体为空
