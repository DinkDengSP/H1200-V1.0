...
//任务的控制块
TX_THREAD tcbSrvTaskSocketCan2@".ccram";
//任务堆栈
uint64_t stackBufferSrvTaskSocketCan2[STK_SIZE_SRV_TASK_SOCKET_CAN2/8]@".ccram";
//任务消息队列控制块
TX_QUEUE queueSrvTaskSocketCan2@".ccram";
//消息缓冲区
uint32_t queueBufferSrvTaskSocketCan2[LENGTH_QUEUE_SRV_TASK_SOCKET_CAN2]@".ccram";
//SOCKET CAN2 ACK SEND消息队列
TX_QUEUE queueSocketCan2AckSend@".ccram";
//消息缓冲区
uint32_t queueBufferSocketCan2AckSend[LENGTH_QUEUE_SRV_SOCKET_ACK_SEND_CAN2]@".ccram";
