...
//任务的控制块
TX_THREAD tcbSrvTaskStepMotor6@".ccram";
//任务堆栈
uint64_t stackBufferSrvTaskStepMotor6[STK_SIZE_SRV_TASK_STEP_MOTOR6/8]@".ccram";
//任务消息队列控制块
TX_QUEUE queueSrvTaskStepMotor6@".ccram";
//消息缓冲区
uint32_t queueBufferSrvTaskStepMotor6[LENGTH_QUEUE_SRV_TASK_STEP_MOTOR6]@".ccram";
