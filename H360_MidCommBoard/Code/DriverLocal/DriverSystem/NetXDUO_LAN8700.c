 ...
 ** description  : 
 ** LastEditors  : 邓小俊
 ** LastEditTime : 2024-01-30 09:09:26
...
//NETX 驱动层保存的协议栈讯息
static NETX_PORT_INFO_PHY nxPortInfo;
//内存池控制块
...
static void NetX_DriverLAN8700_CapabilitySet(NX_IP_DRIVER *nxLan8700ReqPtr);
static void NetX_DriverLAN8700_CapabilityGet(NX_IP_DRIVER *nxLan8700ReqPtr);
...
static void NetX_DriverLAN8700_InterfaceAttach(NX_IP_DRIVER *nxLan8700ReqPtr)
{
    ...
    //接口扩展能力
#ifdef NX_ENABLE_INTERFACE_CAPABILITY
    nxLan8700ReqPtr->nx_ip_driver_interface->nx_interface_capability_flag = NX_DRIVER_CAPABILITY;
#endif 
    //状态修改为IP附着
    nxPortInfo.nxPortInfoState = NETX_PORT_STATE_ATTACH;
    //返回成功
...
{
    //获取扩展能力
    *(nxLan8700ReqPtr -> nx_ip_driver_return_ptr) = NX_DRIVER_CAPABILITY;
    //状态成功
    nxLan8700ReqPtr -> nx_ip_driver_status =  NX_SUCCESS;
}
