...
** LastEditTime  : 2023-11-07 08:46:34 +0800
************************************************************************************************/ 
...
//CAN指令消息处理函数
void ModMsgCan1UtilCmd(void* can1MsgBodyPtr)
{
    //转换指令码
...
/*************************************************************CAN上传参数处理***********************************************************/
//占位函数
static void ModMsgCan1UtilUpload_PlaceHolder(CAN_PROT_UPLOAD_PACK* canUploadPackPtr);
...
//CAN上传消息处理函数
void ModMsgCan1UtilUpload(void* can1MsgBodyPtr)
{
