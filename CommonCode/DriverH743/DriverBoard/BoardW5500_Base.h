...
** Date          : 2023-03-13 15:44:52 +0800
** Description   : When I Has Time ,I Will Write Description Below:
** ModifyRecord1 :    
** ModifyRecord2 :    
** LastEditors   : DengXiaoJun(邓小俊)
** LastEditTime  : 2023-03-13 15:44:59 +0800
************************************************************************************************/ 
...
//设备复位一下
void BoardW5500_ResetHardware(void);
...
//写入源 MAC 地址寄存器
ERROR_SUB BoardW5500_WriteBaseSourceMacAddrReg(uint8_t macAddr1,uint8_t macAddr2,uint8_t macAddr3,uint8_t macAddr4,uint8_t macAddr5,uint8_t macAddr6);

//读取源 MAC 地址寄存器
ERROR_SUB BoardW5500_ReadBaseSourceMacAddrReg(uint8_t* macAddr1Ptr,uint8_t* macAddr2Ptr,uint8_t* macAddr3Ptr,uint8_t* macAddr4Ptr,uint8_t* macAddr5Ptr,uint8_t*macAddr6Ptr);
...
ERROR_SUB BoardW5500_WriteBasePoeTargetMacAddrReg(uint8_t macAddr1,uint8_t macAddr2,uint8_t macAddr3,uint8_t macAddr4,uint8_t macAddr5,uint8_t macAddr6);

//读取PHAR PPPoE 模式下目标 MAC 寄存器
ERROR_SUB BoardW5500_ReadBasePoeTargetMacAddrReg(uint8_t* macAddr1Ptr,uint8_t*macAddr2Ptr,uint8_t* macAddr3Ptr,uint8_t* macAddr4Ptr,uint8_t* macAddr5Ptr,uint8_t*macAddr6Ptr);
...
ERROR_SUB BoardW5500_WriteSocketDestMacAddrReg(W5500_SOCKET_NO socketNo,uint8_t macAddr1,uint8_t macAddr2,uint8_t macAddr3,uint8_t macAddr4,uint8_t macAddr5,uint8_t macAddr6);
//读取Socket n目的 MAC 地址寄存器
ERROR_SUB BoardW5500_ReadSocketDestMacAddrReg(W5500_SOCKET_NO socketNo,uint8_t*macAddr1Ptr,uint8_t* macAddr2Ptr,uint8_t* macAddr3Ptr,uint8_t* macAddr4Ptr,uint8_t* macAddr5Ptr,uint8_t*macAddr6Ptr);
