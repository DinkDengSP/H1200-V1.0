...
** LastEditTime  : 2023-11-03 12:55:55 +0800
************************************************************************************************/ 
#include "SrvTaskHeader.h"
#include "SrvImplSocketCan1.h"

//任务的控制块
TX_THREAD tcbSrvTaskSocketCan1@".ccram";
//任务堆栈
uint64_t stackBufferSrvTaskSocketCan1[STK_SIZE_SRV_TASK_SOCKET_CAN1/8]@".ccram";
//任务消息队列控制块
TX_QUEUE queueSrvTaskSocketCan1@".ccram";
//消息缓冲区
uint32_t queueBufferSrvTaskSocketCan1[LENGTH_QUEUE_SRV_TASK_SOCKET_CAN1]@".ccram";
//SOCKET CAN1 ACK SEND消息队列
TX_QUEUE queueSocketCan1AckSend@".ccram";
//消息缓冲区
uint32_t queueBufferSocketCan1AckSend[LENGTH_QUEUE_SRV_SOCKET_ACK_SEND_CAN1]@".ccram";
