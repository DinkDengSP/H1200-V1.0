...
** LastEditTime  : 2023-11-02 13:24:53 +0800
************************************************************************************************/ 
...
//是否支持上报ID,0不支持,1支持
#define CAN2_PROT_UPLOAD_SUPPORT                    CONFIG_FUNC_DISABLE
//协议支持的数据长度定义
#if(MCU_CAN2_MODE_USER == MCU_CAN_MODE_CLASSICAL)
#define CAN2_PROT_DATA_BUF_LEN                      MCU_CAN_DATA_LEN_MAX_CLASSICAL
#else
#define CAN2_PROT_DATA_BUF_LEN                      MCU_CAN_DATA_LEN_MAX_FD
#endif
