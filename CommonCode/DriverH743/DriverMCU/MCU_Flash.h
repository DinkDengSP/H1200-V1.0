...
** LastEditTime  : 2023-10-19 17:07:28 +0800
************************************************************************************************/ 
...
//从指定地址开始读出指定长度的数据
ERROR_SUB MCU_FlashReadBuffer(uint32_t readAddr,uint32_t *bufferPtr,uint32_t dwordNumber);

//从指定地址开始读出指定长度的数据
ERROR_SUB MCU_FlashReadBufferBytes(uint32_t readAddr,uint8_t *bufferPtr,uint32_t byteCount);
