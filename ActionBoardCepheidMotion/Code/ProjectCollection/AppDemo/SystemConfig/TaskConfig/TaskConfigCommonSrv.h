...
** LastEditTime  : 2023-11-02 12:10:31 +0800
************************************************************************************************/ 
...
/********************************************CAN1接收任务相关配置********************************************************/
//是否使能CAN1 SOCKET
#define CAN1_SOCKET_COMM_ENABLE                                         CONFIG_FUNC_DISABLE
//自动运行程序的执行周期,单位毫秒,当不需要周期执行函数的时候,将该值定义为 SYS_TASK_FSM_NOT_EXIST
//否则定义成想要运行的周期
...
/********************************************CAN2接收任务相关配置********************************************************/
//是否使能CAN2 SOCKET
#define CAN2_SOCKET_COMM_ENABLE                                         CONFIG_FUNC_ENABLE
//自动运行程序的执行周期,单位毫秒,当不需要周期执行函数的时候,将该值定义为 SYS_TASK_FSM_NOT_EXIST
//否则定义成想要运行的周期
#define SRV_TASK_SOCKET_CAN2_FSM_PERIOD_MS                              20
//状态机执行间隔逻辑
...
//任务优先级
#define PRIO_SRV_TASK_SOCKET_CAN2                                       3
//任务堆栈大小
...
//是否使用CAN1 SOCKET1打印
#define SYSTEM_LOG_OUT_SOCKET_CAN1_ENABLE                               CONFIG_FUNC_DISABLE
//是否使用CAN2 SOCKET2打印
#define SYSTEM_LOG_OUT_SOCKET_CAN2_ENABLE                               CONFIG_FUNC_ENABLE
/**********************************************************************************************************************/
