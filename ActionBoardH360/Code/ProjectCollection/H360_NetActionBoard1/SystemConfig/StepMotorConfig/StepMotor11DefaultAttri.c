...
** LastEditTime  : 2023-12-04 16:07:39 +0800
************************************************************************************************/ 
#include "StepMotorParam.h"
//步进电机11:  清洗盘旋转(描述电机名称)
//步进电机默认配置
const STEP_MOTOR_ATTRIBUTE StepMotor11DefaultAttri = {
    SM_CONFIG_FLAG,
    //基础配置
    {
        BOARD_PORT_IN_ARM_SEN11_PI6,//BOARD_IN_PIN resetPinIndex;复位引脚
        ...
        62.5f,//float resetSpeedFast;复位速度,快速,主要用在找原点
