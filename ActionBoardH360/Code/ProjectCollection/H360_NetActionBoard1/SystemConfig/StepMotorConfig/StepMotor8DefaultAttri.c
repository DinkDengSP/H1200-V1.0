...
** LastEditTime  : 2023-12-05 09:10:01 +0800
************************************************************************************************/ 
#include "StepMotorParam.h"
//步进电机8:  清洗摇匀旋转(描述电机名称)
//步进电机默认配置
const STEP_MOTOR_ATTRIBUTE StepMotor8DefaultAttri = {
    SM_CONFIG_FLAG,
    //基础配置
    {
        BOARD_PORT_IN_ARM_SEN8_PE3,//BOARD_IN_PIN resetPinIndex;复位引脚
        ...
        3000,//uint32_t resetMaxSteps;电机复位最大行程
