                                    ...
                                    uint16_t* dataBufLen)
{
    ...
    *dataBufPtrPtr = UserMemMallocWhileSuccess(MEM_REGION_SRV_TASK,*dataBufLen);
    ...
    {
        errorSub = SysParamReadSingle((INDEX_MAIN_SYS_PARAM)(readParaPairDataArrayPtr[indexParam*2]),
                                    ...
                                    uint16_t* dataBufLen)
{
    ...
    *dataBufPtrPtr = NULL;
    ...
    for(indexParam = 0; indexParam < writeParamPair; indexParam++)
    {
        ...
        //执行写入
        errorSub = SysParamWriteSingle((INDEX_MAIN_SYS_PARAM)(writeParamPairArrayPtr[indexParam*6]),
