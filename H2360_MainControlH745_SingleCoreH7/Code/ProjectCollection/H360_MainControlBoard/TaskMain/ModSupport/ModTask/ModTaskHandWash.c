...
//任务的控制块
TX_THREAD tcbModTaskHandWash@".dtcm_ram";
//任务堆栈
uint64_t stackBufferModTaskHandWash[STK_SIZE_MOD_TASK_HAND_WASH/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueModTaskHandWash@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferModTaskHandWash[LENGTH_QUEUE_MOD_TASK_HAND_WASH]@".dtcm_ram";
