...
** LastEditTime  : 2023-11-07 19:17:41 +0800
************************************************************************************************/ 
...
/*---------------------------------------------------板卡上EC20端口----------------------------------------------------------*/
//EC20_UART6 通讯波特率
#define BOARD_EC20_UART6_BAUD                                   115200
//EC20_UART6 单字节长度             
#define BOARD_EC20_UART6_LENGTH                                 MCU_UART_LENGTH_8B
//EC20_UART6 停止位             
#define BOARD_EC20_UART6_STOP_BIT                               MCU_UART_STOPBIT1
//EC20_UART6 校验模式               
#define BOARD_EC20_UART6_CHECK_MODE                             MCU_UART_CHECK_MODE_NONE
//EC20 PWR引脚
#define PIN_BOARD_EC20_PWR                                      MCU_PIN_E_2
//EC20 PWR引脚有效值
#define VALID_LEVEL_PIN_BOARD_EC20_PWR                          GPIO_PIN_RESET
//EC20复位引脚
#define PIN_BOARD_EC20_RST                                      MCU_PIN_E_3
//EC20复位引脚有效值
#define VALID_LEVEL_PIN_BOARD_EC20_RST                          GPIO_PIN_SET
//EC20接收消息队列长度
#define LENGTH_QUEUE_BOARD_EC20_RECV                            32
//EC20接收数据缓冲区
#define COMM_CACHE_LENGTH_BOARD_EC20                            4096
//EC20消息处理循环时间
#define PERIOD_MS_PROC_BOARD_EC20_RECV_MSG                      50
//探针端口是否启用
#define BOARD_EC20_PROBE_ENABLE                                 CONFIG_FUNC_ENABLE
