 ...
 ** description  : 
 ** LastEditors  : 邓小俊
 ** LastEditTime : 2024-01-16 14:05:45
...
//任务的控制块
TX_THREAD tcbSrvTaskSysLog@".dtcm_ram";
//任务堆栈
uint64_t stackBufferSrvTaskSysLog[STK_SIZE_SRV_TASK_SYS_LOG/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueSrvTaskSysLog@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferSrvTaskSysLog[LENGTH_QUEUE_SRV_TASK_SYS_LOG]@".dtcm_ram";
