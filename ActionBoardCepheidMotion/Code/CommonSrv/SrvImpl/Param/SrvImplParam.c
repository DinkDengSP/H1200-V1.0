...
//CAN1指令消息处理函数
extern void SrvMsgCan1ParamCmd(void* canMsgBodyPtr);
//CAN1上传消息处理函数
extern void SrvMsgCan1ParamUpload(void* canMsgBodyPtr);
//CAN2指令消息处理函数
extern void SrvMsgCan2ParamCmd(void* canMsgBodyPtr);
//CAN2上传消息处理函数
extern void SrvMsgCan2ParamUpload(void* canMsgBodyPtr);
//IPC指令消息处理函数
extern void SrvMsgIpcParamCmd(void* ipcMsgBodyPtr);
//IPC上传消息处理函数
extern void SrvMsgIpcParamUpload(void* ipcMsgBodyPtr);
