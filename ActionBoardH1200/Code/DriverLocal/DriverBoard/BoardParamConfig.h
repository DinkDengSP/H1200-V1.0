...
//服务层参数的起始地址
#define ADDR_BOARD_SRV_PARAM_START                      0X00004000
//服务层参数的最大长度,64KB
...
//存放在线升级BOOT文件的起始地址
#define ADDR_BOARD_IAP_BOOT_BIN_FILE_START              0X00000000
...
#define LENGTH_BOARD_IAP_SRV_BIN_FILE                   ((768*1024)+(1024*1024))

//存放在线升级APP文件的起始地址
#define ADDR_BOARD_IAP_APP_BIN_FILE_START               (ADDR_BOARD_IAP_SRV_BIN_FILE_START+LENGTH_BOARD_IAP_SRV_BIN_FILE)
#define LENGTH_BOARD_IAP_APP_BIN_FILE                   ((768*1024)+(1024*1024))


/*-------------------------------默认数据标记-----------------------------------------*/
//默认IP
#define DEFAULT_VALUE_BOARD_PARAM_NET_PHY1_IP           0XF01FA8C0
//默认IP
#define DEFAULT_VALUE_BOARD_PARAM_NET_PHY2_IP           0XF11FA8C0
