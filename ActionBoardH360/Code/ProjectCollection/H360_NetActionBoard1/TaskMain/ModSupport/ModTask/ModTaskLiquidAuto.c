...
//任务的控制块
TX_THREAD tcbModTaskLiquidAuto;
//任务堆栈
uint64_t stackBufferModTaskLiquidAuto[STK_SIZE_MOD_TASK_LIQUID_AUTO/8];
//任务消息队列控制块
TX_QUEUE queueModTaskLiquidAuto@".ccram";
//消息缓冲区
uint32_t queueBufferModTaskLiquidAuto[LENGTH_QUEUE_MOD_TASK_LIQUID_AUTO];
