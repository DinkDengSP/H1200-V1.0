...
** LastEditTime  : 2023-11-06 14:35:26 +0800
************************************************************************************************/ 
#include "AppTaskHeader.h"
#include "AppImplUtil.h"

//任务的控制块
TX_THREAD tcbAppTaskUtil@".dtcm_ram";
//任务堆栈
uint64_t stackBufferAppTaskUtil[STK_SIZE_APP_TASK_UTIL/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueAppTaskUtil@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferAppTaskUtil[LENGTH_QUEUE_APP_TASK_UTIL]@".dtcm_ram";
