...
//任务的控制块
TX_THREAD tcbModTaskUtil@".dtcm_ram";
//任务堆栈
uint64_t stackBufferModTaskUtil[STK_SIZE_MOD_TASK_UTIL/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueModTaskUtil@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferModTaskUtil[LENGTH_QUEUE_MOD_TASK_UTIL]@".dtcm_ram";
