...
//任务的控制块
TX_THREAD tcbModTaskMixReagent;
//任务堆栈
uint64_t stackBufferModTaskMixReagent[STK_SIZE_MOD_TASK_MIX_REAGENT/8];
//任务消息队列控制块
TX_QUEUE queueModTaskMixReagent@".ccram";
//消息缓冲区
uint32_t queueBufferModTaskMixReagent[LENGTH_QUEUE_MOD_TASK_MIX_REAGENT];
