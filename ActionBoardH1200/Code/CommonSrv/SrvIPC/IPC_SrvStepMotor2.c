...
//通道携带的数据缓存长度
#define LENGTH_BUFFER_IPC_SRV_STEP_MOTOR2             32
//IPC通道讯息
...
void IPC_SrvStepMotor2QueryLastCmdState(IPC_CMD_STAGE* cmdStagePtr,SYS_RESULT_PACK* resultPackPtr,IPC_RETURN_DATA* returnDataPtr)
{
    ...
    errorSub = IPC_BaseQueryLastCmdState(&ipcChannelDataSrvStepMotor2,cmdStagePtr,resultPackPtr);
    if(errorSub != ERROR_SUB_OK)
    {
        SystemPrintf("%s,ErrorSub: 0X%08X\r\n",__func__,errorSub);
        CoreUtilSetSystemResultPack(resultPackPtr,PROT_RESULT_FAIL,ERROR_MAIN_IPC_PROT_QUERY_CMD_STATE,ERROR_LEVEL_ERROR,
...
//电机失能,WAIT
void IPC_SrvStepMotor2DisableWaitCmdReturn(SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    //等待返回
    errorSub = IPC_BaseWaitCmdReturn(&ipcChannelDataSrvStepMotor2,IPC_CMD_MACRO_STEP_MOTOR_DISABLE,resultPackPtr);
    if(errorSub != ERROR_SUB_OK)
    {
...
//电机进入教学模式,WAIT
void IPC_SrvStepMotor2EnterTeachModeWaitCmdReturn(SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    //等待返回
    errorSub = IPC_BaseWaitCmdReturn(&ipcChannelDataSrvStepMotor2,IPC_CMD_MACRO_STEP_MOTOR_ENTER_TEACH_MODE,resultPackPtr);
    if(errorSub != ERROR_SUB_OK)
    {
...
//电机强行进入默认状态,WAIT
void IPC_SrvStepMotor2ForceEnterDefaultWaitCmdReturn(SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    //等待返回
    errorSub = IPC_BaseWaitCmdReturn(&ipcChannelDataSrvStepMotor2,IPC_CMD_MACRO_STEP_MOTOR_FORCE_TO_DEFAULT,resultPackPtr);
    if(errorSub != ERROR_SUB_OK)
    {
...
//电机失能,QUERY
void IPC_SrvStepMotor2QueryDisableState(IPC_CMD_STAGE* cmdStagePtr,SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    //查询状态
    errorSub = IPC_BaseQueryCmdState(&ipcChannelDataSrvStepMotor2,IPC_CMD_MACRO_STEP_MOTOR_DISABLE,cmdStagePtr,resultPackPtr);
    if(errorSub != ERROR_SUB_OK)
    {
        SystemPrintf("%s,Cmd: 0X%08X,ErrorSub: 0X%08X\r\n",__func__,IPC_CMD_MACRO_STEP_MOTOR_DISABLE,errorSub);
        //IPC报错,返回错误
...
//电机进入教学模式,QUERY
void IPC_SrvStepMotor2QueryEnterTeachModeState(IPC_CMD_STAGE* cmdStagePtr,SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    //查询状态
    errorSub = IPC_BaseQueryCmdState(&ipcChannelDataSrvStepMotor2,IPC_CMD_MACRO_STEP_MOTOR_ENTER_TEACH_MODE,cmdStagePtr,resultPackPtr);
    if(errorSub != ERROR_SUB_OK)
    {
        SystemPrintf("%s,Cmd: 0X%08X,ErrorSub: 0X%08X\r\n",__func__,IPC_CMD_MACRO_STEP_MOTOR_ENTER_TEACH_MODE,errorSub);
        //IPC报错,返回错误
...
//电机强行进入默认状态,QUERY
void IPC_SrvStepMotor2QueryForceEnterDefaultState(IPC_CMD_STAGE* cmdStagePtr,SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    //查询状态
    errorSub = IPC_BaseQueryCmdState(&ipcChannelDataSrvStepMotor2,IPC_CMD_MACRO_STEP_MOTOR_FORCE_TO_DEFAULT,cmdStagePtr,resultPackPtr);
    if(errorSub != ERROR_SUB_OK)
    {
        SystemPrintf("%s,Cmd: 0X%08X,ErrorSub: 0X%08X\r\n",__func__,IPC_CMD_MACRO_STEP_MOTOR_FORCE_TO_DEFAULT,errorSub);
        //IPC报错,返回错误
...
//电机失能,ACK
void IPC_SrvStepMotor2DisableWhileAck(SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    errorSub = IPC_SrvStepMotor2CheckClearLastCmd(IPC_CMD_MACRO_STEP_MOTOR_DISABLE);
    if(errorSub != ERROR_SUB_OK)
    {
        CoreUtilSetSystemResultPack(resultPackPtr,PROT_RESULT_FAIL,ERROR_MAIN_IPC_PROT_CLEAR_LAST_CMD,ERROR_LEVEL_ERROR,
                                        errorSub);
...
//电机进入教学模式,ACK
void IPC_SrvStepMotor2EnterTeachModeWhileAck(SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    errorSub = IPC_SrvStepMotor2CheckClearLastCmd(IPC_CMD_MACRO_STEP_MOTOR_ENTER_TEACH_MODE);
    if(errorSub != ERROR_SUB_OK)
    {
        CoreUtilSetSystemResultPack(resultPackPtr,PROT_RESULT_FAIL,ERROR_MAIN_IPC_PROT_CLEAR_LAST_CMD,ERROR_LEVEL_ERROR,
                                        errorSub);
...
//电机强行进入默认状态,ACK
void IPC_SrvStepMotor2ForceEnterDefaultWhileAck(SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    errorSub = IPC_SrvStepMotor2CheckClearLastCmd(IPC_CMD_MACRO_STEP_MOTOR_FORCE_TO_DEFAULT);
    if(errorSub != ERROR_SUB_OK)
    {
        CoreUtilSetSystemResultPack(resultPackPtr,PROT_RESULT_FAIL,ERROR_MAIN_IPC_PROT_CLEAR_LAST_CMD,ERROR_LEVEL_ERROR,
                                        errorSub);
...
//电机失能,RETURN
void IPC_SrvStepMotor2DisableWhileReturn(SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    errorSub = IPC_SrvStepMotor2CheckClearLastCmd(IPC_CMD_MACRO_STEP_MOTOR_DISABLE);
    if(errorSub != ERROR_SUB_OK)
...
//电机进入教学模式,RETURN
void IPC_SrvStepMotor2EnterTeachModeWhileReturn(SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    errorSub = IPC_SrvStepMotor2CheckClearLastCmd(IPC_CMD_MACRO_STEP_MOTOR_ENTER_TEACH_MODE);
    if(errorSub != ERROR_SUB_OK)
...
//电机强行进入默认状态,RETURN
void IPC_SrvStepMotor2ForceEnterDefaultWhileReturn(SYS_RESULT_PACK* resultPackPtr)
{
    ERROR_SUB errorSub = ERROR_SUB_OK;
    errorSub = IPC_SrvStepMotor2CheckClearLastCmd(IPC_CMD_MACRO_STEP_MOTOR_FORCE_TO_DEFAULT);
    if(errorSub != ERROR_SUB_OK)
...
/*****************************************************独立API************************************************************/
//设置电机状态
void IPC_SrvStepMotor2SetState(STEP_MOTOR_STATE_MAIN mainState,STEP_MOTOR_STATE_SUB subState)
{
    STEP_MOTOR_DATA_SET* motorDataSetPtr = StepMotorBaseGetDataSetPtr(STEP_MOTOR_NO2);
...
{
    //步进电机写入急停
    StepMotorMainEmStopCmd(STEP_MOTOR_NO2);
}
...
void IPC_SrvStepMotor2ModifyMotorCordinate(int32_t motorCurrentCoordinate)
{
        ...
        (motorDataSetPtr->attriPtr->motorEncoderAttri.encoderSet == DISABLE))
    {
        ...
        StepMotorMainForceToDefaultState(STEP_MOTOR_NO2);
        //设置坐标
...
int32_t IPC_SrvStepMotor2GetRealTimeCoordinate(void)
{
    int32_t motorPos;
    int32_t encoderPos;
    StepMotorReadMotorRealTimePosAndEncoderPos(STEP_MOTOR_NO2,&motorPos,&encoderPos);
    return motorPos;
}
