...
** LastEditTime  : 2023-10-26 14:33:52 +0800
************************************************************************************************/ 
...
{
    stepMotorVarArray[STEP_MOTOR_NO1].var.motorMainState = mainState;
    stepMotorVarArray[STEP_MOTOR_NO1].var.motorSubState = subState;
}

//修改电机坐标
void IPC_SrvStepMotor1ModifyMotorCordinate(int32_t motorCurrentCoordinate)
{
    stepMotorVarArray[STEP_MOTOR_NO1].var.currentCoordinate = motorCurrentCoordinate;
}
...
FlagStatus IPC_SrvStepMotor1CheckEmergencyStopCmd(void)
{
    if((stepMotorVarArray[STEP_MOTOR_NO1].var.motorMainState == STEP_MOTOR_MAIN_STOP)&&
        (stepMotorVarArray[STEP_MOTOR_NO1].var.motorSubState == STEP_MOTOR_STOP_SUB_EMERGENCY_CMD))
    {
        return SET;
    }
    return RESET;
