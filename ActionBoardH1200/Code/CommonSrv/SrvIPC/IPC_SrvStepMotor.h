...
//电机失能
void IPC_SrvStepMotorDisableWaitCmdReturn(STEP_MOTOR_NO motorNo,SYS_RESULT_PACK* resultPackPtr);
//电机进入教学模式
void IPC_SrvStepMotorEnterTeachModeWaitCmdReturn(STEP_MOTOR_NO motorNo,SYS_RESULT_PACK* resultPackPtr);
//电机强行进入默认状态
void IPC_SrvStepMotorForceEnterDefaultWaitCmdReturn(STEP_MOTOR_NO motorNo,SYS_RESULT_PACK* resultPackPtr);
...
//电机失能,QUERY
void IPC_SrvStepMotorQueryDisableState(STEP_MOTOR_NO motorNo,IPC_CMD_STAGE* cmdStagePtr,SYS_RESULT_PACK* resultPackPtr);
//电机进入教学模式,QUERY
void IPC_SrvStepMotorQueryEnterTeachModeState(STEP_MOTOR_NO motorNo,IPC_CMD_STAGE* cmdStagePtr,SYS_RESULT_PACK* resultPackPtr);
//电机强行进入默认状态,QUERY
void IPC_SrvStepMotorQueryForceEnterDefaultState(STEP_MOTOR_NO motorNo,IPC_CMD_STAGE* cmdStagePtr,SYS_RESULT_PACK* resultPackPtr);
...
//电机失能
void IPC_SrvStepMotorDisableWhileAck(STEP_MOTOR_NO motorNo,SYS_RESULT_PACK* resultPackPtr);
//电机进入教学模式
void IPC_SrvStepMotorEnterTeachModeWhileAck(STEP_MOTOR_NO motorNo,SYS_RESULT_PACK* resultPackPtr);
//电机强行进入默认状态
void IPC_SrvStepMotorForceEnterDefaultWhileAck(STEP_MOTOR_NO motorNo,SYS_RESULT_PACK* resultPackPtr);
...
//电机失能
void IPC_SrvStepMotorDisableWhileReturn(STEP_MOTOR_NO motorNo,SYS_RESULT_PACK* resultPackPtr);
//电机进入教学模式
void IPC_SrvStepMotorEnterTeachModeWhileReturn(STEP_MOTOR_NO motorNo,SYS_RESULT_PACK* resultPackPtr);
//电机强行进入默认状态
void IPC_SrvStepMotorForceEnterDefaultWhileReturn(STEP_MOTOR_NO motorNo,SYS_RESULT_PACK* resultPackPtr);

/*****************************************************独立API************************************************************/
//设置电机状态
void IPC_SrvStepMotorSetState(STEP_MOTOR_NO motorNo,STEP_MOTOR_STATE_MAIN mainState,STEP_MOTOR_STATE_SUB subState);
//电机急停
void IPC_SrvStepMotorEmergencyStop(STEP_MOTOR_NO motorNo);
//修改电机坐标
void IPC_SrvStepMotorModifyMotorCordinate(STEP_MOTOR_NO motorNo,int32_t motorCurrentCoordinate);
//获取电机实时坐标
int32_t IPC_SrvStepMotorGetRealTimeCoordinate(STEP_MOTOR_NO motorNo);
//检查电机是否指令急停
