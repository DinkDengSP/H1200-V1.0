...
//任务的控制块
TX_THREAD tcbModTaskNeedleReagent;
//任务堆栈
uint64_t stackBufferModTaskNeedleReagent[STK_SIZE_MOD_TASK_NEEDLE_REAGENT/8];
//任务消息队列控制块
TX_QUEUE queueModTaskNeedleReagent@".ccram";
//消息缓冲区
uint32_t queueBufferModTaskNeedleReagent[LENGTH_QUEUE_MOD_TASK_NEEDLE_REAGENT];
