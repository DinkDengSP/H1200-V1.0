...
static const USER_CAN_CMD_PROC_UNIT can1CmdProcDemoUnitArray[] = 
{
    ...
    {CAN_MASTER_CMD_PLACE_HOLDER          ,1  ,ENABLE ,SrvMsgCan1DemoCmd_PlaceHolder    },
};


//CAN指令消息处理函数
void SrvMsgCan1DemoCmd(void* canMsgBodyPtr)
{
    //转换指令码
...
/*************************************************************CAN上传参数处理***********************************************************/
//占位函数
static void SrvMsgCan1DemoUpload_PlaceHolder(CAN_PROT_UPLOAD_PACK* canUploadPackRecvPtr);
...
//CAN上传消息处理函数
void SrvMsgCan1DemoUpload(void* canMsgBodyPtr)
{
