...
#include "SrvImplBaseStepMotor8.h"


/*******************************************CAN指令处理函数列表*************************************************/
//占位函数
static void SrvMsgCan1StepMotor8Cmd_PlaceHolder(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机复位
static void SrvMsgCan1StepMotor8Cmd_Reset(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机走步数
static void SrvMsgCan1StepMotor8Cmd_RunStep(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机走坐标
static void SrvMsgCan1StepMotor8Cmd_RunCoordinate(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机回零
static void SrvMsgCan1StepMotor8Cmd_ReturnZero(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机持续运转
static void SrvMsgCan1StepMotor8Cmd_RunAlways(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机立即停止
static void SrvMsgCan1StepMotor8Cmd_StopNow(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机减速停止
static void SrvMsgCan1StepMotor8Cmd_StopSlowDown(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//获取电机当前坐标
static void SrvMsgCan1StepMotor8Cmd_GetCoordinate(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//获取当前原点传感器状态
static void SrvMsgCan1StepMotor8Cmd_ReadOriginSensor(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机失能
static void SrvMsgCan1StepMotor8Cmd_Disable(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机进入教学模式
static void SrvMsgCan1StepMotor8Cmd_EnterTeachMode(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);
//电机强行进入默认状态
static void SrvMsgCan1StepMotor8Cmd_ForceToDefault(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen);

//CAN指令处理函数列表
static const USER_CAN_CMD_PROC_UNIT can1CmdProcStepMotor8UnitArray[] = 
{
    //顺序是 指令码 预期参数最小长度 是否需要结果返回  错误是否独立上报 指令处理函数
    {CAN_MASTER_CMD_PLACE_HOLDER            ,0  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_PlaceHolder       },
    {CAN_MASTER_CMD_SM_RESET                ,9  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_Reset             },
    {CAN_MASTER_CMD_SM_RUN_STEPS            ,19 ,ENABLE ,SrvMsgCan1StepMotor8Cmd_RunStep           },
    {CAN_MASTER_CMD_SM_RUN_COORDINATE       ,19 ,ENABLE ,SrvMsgCan1StepMotor8Cmd_RunCoordinate     },
    {CAN_MASTER_CMD_SM_RETURN_ZERO          ,20 ,ENABLE ,SrvMsgCan1StepMotor8Cmd_ReturnZero        },
    {CAN_MASTER_CMD_SM_RUN_ALWAYS           ,5  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_RunAlways         },
    {CAN_MASTER_CMD_SM_STOP_NOW             ,0  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_StopNow           },
    {CAN_MASTER_CMD_SM_STOP_SLOW_DOWN       ,9  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_StopSlowDown      },
    {CAN_MASTER_CMD_SM_GET_COORDINATE       ,0  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_GetCoordinate     },
    {CAN_MASTER_CMD_SM_READ_ORIGIN_SENSOR   ,0  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_ReadOriginSensor  },
    {CAN_MASTER_CMD_SM_DISABLE              ,0  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_Disable           },
    {CAN_MASTER_CMD_SM_ENTER_TEACH_MODE     ,0  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_EnterTeachMode    },
    {CAN_MASTER_CMD_SM_FORCE_TO_DEFAULT     ,0  ,ENABLE ,SrvMsgCan1StepMotor8Cmd_ForceToDefault    },
};


//CAN指令消息处理函数
void SrvMsgCan1StepMotor8Cmd(void* can1MsgBodyPtr)
{
    //转换指令码
    ...
    for(indexUtil = 0; indexUtil < DIM_ARRAY_ELEMENT_COUNT(can1CmdProcStepMotor8UnitArray);indexUtil++)
    {
        if(cmdPackPtr->cmdValue == (uint32_t)(can1CmdProcStepMotor8UnitArray[indexUtil].commandCode))
        {
            break;
        }
    }
    //判定序号
    if(indexUtil == DIM_ARRAY_ELEMENT_COUNT(can1CmdProcStepMotor8UnitArray))
    {
        //不支持的指令
    ...
    //判定长度
    if(cmdPackPtr->paramBufferLength < can1CmdProcStepMotor8UnitArray[indexUtil].exceptParamLengthMin)
    {
        //小于最小指令预期长度
        SystemPrintf("E:> %s,%d,Recv ExceptMinParamLength:%d ,Real: %d,CommandCode: 0X%08X\r\n",__func__,__LINE__,
                        can1CmdProcStepMotor8UnitArray[indexUtil].exceptParamLengthMin,cmdPackPtr->paramBufferLength,
                        cmdPackPtr->cmdValue);
        //释放内存
        if((cmdPackPtr->paramBufferPtr != NULL)&&(cmdPackPtr->paramBufferLength != 0))
        {
    ...
    //检测函数指针
    if(can1CmdProcStepMotor8UnitArray[indexUtil].canCmdProcFuncPtr == NULL)
    {
    ...
    //调用处理函数
    can1CmdProcStepMotor8UnitArray[indexUtil].canCmdProcFuncPtr(cmdPackPtr,&resultPack,&resultDataBufferPtr,&resultDataLength);
    //结果处理,是否需要结果回传
    if(can1CmdProcStepMotor8UnitArray[indexUtil].needResultReply == ENABLE)
    {
        //需要结果回传
...
static void SrvMsgCan1StepMotor8Cmd_Reset(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    stepMotorResetCmd.motorNo = STEP_MOTOR_NO8;
    ...
    //调用实现API
    SrvImplBaseStepMotor8Reset(&stepMotorResetCmd,resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_RunStep(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    runStepCmd.motorNo = STEP_MOTOR_NO8;
    ...
    //执行走步数
    SrvImplBaseStepMotor8RunStep(&runStepCmd,resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_RunCoordinate(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    runCoordinateCmd.motorNo = STEP_MOTOR_NO8;
    ...
    //执行走坐标
    SrvImplBaseStepMotor8RunCoordinate(&runCoordinateCmd,resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
//电机回零
static void SrvMsgCan1StepMotor8Cmd_ReturnZero(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    returnZeroCmd.motorNo = STEP_MOTOR_NO8;
    ...
    //执行电机回零
    SrvImplBaseStepMotor8ReturnZero(&returnZeroCmd,resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_RunAlways(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    runAlwaysCmd.motorNo = STEP_MOTOR_NO8;
    ...
    //执行持续运转
    SrvImplBaseStepMotor8RunAlways(&runAlwaysCmd,resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_StopNow(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    SystemPrintf("%s\r\n",__func__);
    //立即停止
    SrvImplBaseStepMotor8StopNow(resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_StopSlowDown(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    //执行减速停止
    SrvImplBaseStepMotor8StopSlowDown(slowDownMode,slowDownSteps,timeOutMs,resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_GetCoordinate(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    SystemPrintf("%s\r\n",__func__);
    //调用实现API
    SrvImplBaseStepMotor8GetCoordinate(resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_ReadOriginSensor(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    SystemPrintf("%s\r\n",__func__);
    //调用实现API
    SrvImplBaseStepMotor8ReadOriginSensor(resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_Disable(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    SystemPrintf("%s\r\n",__func__);
    //调用实现API
    SrvImplBaseStepMotor8Disable(resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_EnterTeachMode(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    SystemPrintf("%s\r\n",__func__);
    //调用实现API
    SrvImplBaseStepMotor8EnterTeachMode(resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
...
static void SrvMsgCan1StepMotor8Cmd_ForceToDefault(CAN_PROT_CMD_PACK* cmdPackPtr,SYS_RESULT_PACK* resultPackPtr,uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    SystemPrintf("%s\r\n",__func__);
    //调用实现API
    SrvImplBaseStepMotor8ForceToDefault(resultPackPtr,dataBufPtrPtr,dataBufLen);
    return;
}
/*************************************************************************************************************************************/
...
/*************************************************************CAN上传参数处理***********************************************************/
//占位函数
static void SrvMsgCan1StepMotor8Upload_PlaceHolder(CAN_PROT_UPLOAD_PACK* canUploadPackPtr);

//CAN上传消息处理函数列表
static const USER_CAN_UPLOAD_PROC_UNIT can1MsgUploadProcStepMotor8UnitArray[] = 
{
    //顺序是: 指令码 预期参数最小长度 上传消息处理函数
    {CAN_MASTER_REPORT_ID_HOLD_PLACE     ,2 ,SrvMsgCan1StepMotor8Upload_PlaceHolder},
};

//CAN上传消息处理函数
void SrvMsgCan1StepMotor8Upload(void* can1MsgBodyPtr)
{
    ...
    //搜索匹配处理器
    uint16_t indexUtil = 0;
    for(indexUtil = 0; indexUtil < DIM_ARRAY_ELEMENT_COUNT(can1MsgUploadProcStepMotor8UnitArray);indexUtil++)
    {
        if(canUploadPackPtr->uploadID == (uint32_t)(can1MsgUploadProcStepMotor8UnitArray[indexUtil].uploadId))
        {
            break;
        }
    }
    //判定序号
    if(indexUtil == DIM_ARRAY_ELEMENT_COUNT(can1MsgUploadProcStepMotor8UnitArray))
    {
        //不支持的指令
    ...
    //判定长度
    if(canUploadPackPtr->uploadDataBufferLength < can1MsgUploadProcStepMotor8UnitArray[indexUtil].exceptParamLengthMin)
    {
        //小于最小指令预期长度
        SystemPrintf("E:> %s,%d,Recv ExceptMinParamLength:%d ,Real: %d,UploadID: 0X%08X\r\n",__func__,__LINE__,
                        can1MsgUploadProcStepMotor8UnitArray[indexUtil].exceptParamLengthMin,canUploadPackPtr->uploadDataBufferLength,
    ...
    //检测函数指针
    if(can1MsgUploadProcStepMotor8UnitArray[indexUtil].canUploadProcFuncPtr == NULL)
    {
    ...
    //调用指令处理
    can1MsgUploadProcStepMotor8UnitArray[indexUtil].canUploadProcFuncPtr(canUploadPackPtr);
    //处理完成,释放内存
    if((canUploadPackPtr->uploadDataBufferPtr != NULL)&&(canUploadPackPtr->uploadDataBufferLength != 0))
    {
        UserMemFree(MEM_REGION_SYS_MSG_CAN,canUploadPackPtr->uploadDataBufferPtr);
