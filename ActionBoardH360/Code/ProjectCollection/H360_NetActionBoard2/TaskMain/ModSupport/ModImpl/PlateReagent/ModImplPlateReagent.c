...
//CAN1指令消息处理函数
extern void ModMsgCan1PlateReagentCmd(void* can1CmdRecvPtr);
//CAN1上传消息处理函数
extern void ModMsgCan1PlateReagentUpload(void* can1ReportDataPtr);
//IPC指令消息处理函数
extern void ModMsgIpcPlateReagentCmd(void* ipcCmdRecvPtr);
//IPC上传消息处理函数
extern void ModMsgIpcPlateReagentUpload(void* ipcReportDataPtr);
