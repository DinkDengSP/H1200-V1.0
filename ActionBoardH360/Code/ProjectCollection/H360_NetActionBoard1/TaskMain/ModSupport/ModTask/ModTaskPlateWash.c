...
** LastEditTime  : 2023-11-26 23:05:33 +0800
************************************************************************************************/ 
#include "TaskConfigMod.h"
#include "ModImplPlateWash.h"

//任务的控制块
TX_THREAD tcbModTaskPlateWash;
//任务堆栈
uint64_t stackBufferModTaskPlateWash[STK_SIZE_MOD_TASK_PLATE_WASH/8];
//任务消息队列控制块
TX_QUEUE queueModTaskPlateWash@".ccram";
//消息缓冲区
uint32_t queueBufferModTaskPlateWash[LENGTH_QUEUE_MOD_TASK_PLATE_WASH];
