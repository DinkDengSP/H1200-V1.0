...
** LastEditTime  : 2023-10-24 16:00:08 +0800
************************************************************************************************/ 
...
#define TIME_OUT_MS_INTERVAL_LONG_PACK_CAN_PROT         50
...
/****************************************************系统内部板卡编号***************************************************/
//下位机1
#define CAN_MODULE_NO_BOARD1                            SYSTEM_MODULE_NO_ACT
#define CAN_BOARD_ID_BOARD1                             SYSTEM_BOARD_ID_H360_ACT_1
/****************************************************指令转发单元数据结构***************************************************/
//CAN指令转发单元配置
