...
** LastEditTime  : 2023-10-30 16:24:07 +0800
************************************************************************************************/ 
...
//CAN指令消息处理函数
void SrvMsgCan2UtilCmd(void* canMsgBodyPtr)
{
    //转换指令码
...
/*************************************************************CAN上传参数处理***********************************************************/
//占位函数
static void SrvMsgCan2UtilUpload_PlaceHolder(CAN_PROT_UPLOAD_PACK* canUploadPackRecvPtr);
...
//CAN上传消息处理函数
void SrvMsgCan2UtilUpload(void* canMsgBodyPtr)
{
