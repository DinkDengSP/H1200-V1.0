...
/*************************************************************IPC指令处理处理***********************************************************/
//通讯测试
static void SrvMsgIpcStepMotor5Cmd_CommTest(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机复位
static void SrvMsgIpcStepMotor5Cmd_Reset(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机走步数
static void SrvMsgIpcStepMotor5Cmd_RunStep(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机走坐标
static void SrvMsgIpcStepMotor5Cmd_RunCoordinate(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机回零
static void SrvMsgIpcStepMotor5Cmd_ReturnZero(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机持续运转
static void SrvMsgIpcStepMotor5Cmd_RunAlways(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机立即停止
static void SrvMsgIpcStepMotor5Cmd_StopNow(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机减速停止
static void SrvMsgIpcStepMotor5Cmd_StopSlowDown(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//获取电机当前坐标
static void SrvMsgIpcStepMotor5Cmd_GetCoordinate(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//获取当前原点传感器状态
static void SrvMsgIpcStepMotor5Cmd_ReadOriginSensor(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机失能
static void SrvMsgIpcStepMotor5Cmd_Disable(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机进入教学模式
static void SrvMsgIpcStepMotor5Cmd_EnterTeachMode(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机强行进入默认状态
static void SrvMsgIpcStepMotor5Cmd_ForceToDefault(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);

//IPC指令处理函数列表
static const USER_IPC_CMD_PROC_UNIT ipcStepMotor5MsgCmdProcUnitArray[] = 
{
    //顺序是 指令码 预期参数最小长度  指令处理函数
    {(uint32_t)0XFFFFFFFF     ,0    ,SrvMsgIpcStepMotor5Cmd_CommTest  },
    {(uint32_t)0X00000000     ,0    ,SrvMsgIpcStepMotor5Cmd_Reset               },
    {(uint32_t)0X00000001     ,0    ,SrvMsgIpcStepMotor5Cmd_RunStep             },
    {(uint32_t)0X00000002     ,0    ,SrvMsgIpcStepMotor5Cmd_RunCoordinate       },
    {(uint32_t)0X00000003     ,0    ,SrvMsgIpcStepMotor5Cmd_ReturnZero          },
    {(uint32_t)0X00000004     ,0    ,SrvMsgIpcStepMotor5Cmd_RunAlways           },
    {(uint32_t)0X00000005     ,0    ,SrvMsgIpcStepMotor5Cmd_StopNow             },
    {(uint32_t)0X00000006     ,0    ,SrvMsgIpcStepMotor5Cmd_StopSlowDown        },
    {(uint32_t)0X00000007     ,0    ,SrvMsgIpcStepMotor5Cmd_GetCoordinate       },
    {(uint32_t)0X00000008     ,0    ,SrvMsgIpcStepMotor5Cmd_ReadOriginSensor    },
    {(uint32_t)0X00000009     ,0    ,SrvMsgIpcStepMotor5Cmd_Disable             },
    {(uint32_t)0X0000000A     ,0    ,SrvMsgIpcStepMotor5Cmd_EnterTeachMode      },
    {(uint32_t)0X0000000B     ,0    ,SrvMsgIpcStepMotor5Cmd_ForceToDefault      },
};


//IPC指令消息处理函数
void SrvMsgIpcStepMotor5Cmd(void* ipcMsgBodyPtr)
{
    //转换指令码
    ...
    //搜索匹配处理器
    uint16_t indexStepMotor5 = 0;
    for(indexStepMotor5 = 0; indexStepMotor5 < DIM_ARRAY_ELEMENT_COUNT(ipcStepMotor5MsgCmdProcUnitArray);indexStepMotor5++)
    {
        if(ipcCmdMsgPtr->cmdBaseData.commandCode == (uint32_t)(ipcStepMotor5MsgCmdProcUnitArray[indexStepMotor5].commandCode))
        {
            break;
        }
    }
    //判定序号
    if(indexStepMotor5 == DIM_ARRAY_ELEMENT_COUNT(ipcStepMotor5MsgCmdProcUnitArray))
    {
        //不支持的指令
    ...
    //判定长度
    if(ipcCmdMsgPtr->cmdBaseData.cmdParamBufferLength < ipcStepMotor5MsgCmdProcUnitArray[indexStepMotor5].exceptParamLengthMin)
    {
        //小于最小指令预期长度
        SystemPrintf("E:> %s,%d,Recv ExceptMinParamLength:%d ,Real: %d,CommandCode: 0X%08X\r\n",__func__,__LINE__,
                        ipcStepMotor5MsgCmdProcUnitArray[indexStepMotor5].exceptParamLengthMin,ipcCmdMsgPtr->cmdBaseData.cmdParamBufferLength,
    ...
    //检测函数指针
    if(ipcStepMotor5MsgCmdProcUnitArray[indexStepMotor5].ipcCmdProcFuncPtr == NULL)
    {
    ...
    //调用处理函数
    ipcStepMotor5MsgCmdProcUnitArray[indexStepMotor5].ipcCmdProcFuncPtr(&(ipcCmdMsgPtr->cmdBaseData),&sysResultPack,ipcCmdMsgPtr->channelCachePtr);
    //处理完成回传
...
static void SrvMsgIpcStepMotor5Cmd_Reset(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor5Reset(&stepMotorResetCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
...
static void SrvMsgIpcStepMotor5Cmd_RunStep(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor5RunStep(&runStepCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_RunCoordinate(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor5RunCoordinate(&runCoordinateCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_ReturnZero(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor5ReturnZero(&returnZeroCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_RunAlways(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor5RunAlways(&runAlwaysCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_StopNow(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor5StopNow(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_StopSlowDown(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor5StopSlowDown(slowDownMode,slowDownSteps,timeOutMs,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_GetCoordinate(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor5GetCoordinate(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_ReadOriginSensor(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor5ReadOriginSensor(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_Disable(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor5Disable(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_EnterTeachMode(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor5EnterTeachMode(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor5Cmd_ForceToDefault(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor5ForceToDefault(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
/*************************************************************IPC上报讯息处理**********************************************************/
//占位函数
static void SrvMsgIpcStepMotor5Upload_PlaceHolder(IPC_UPLOAD_DATA* ipcUploadDataPtr);

//IPC上传消息处理函数列表
static const USER_IPC_UPLOAD_PROC_UNIT ipcStepMotor5MsgUploadProcUnitArray[] = 
{
    //顺序是: 指令码 预期参数最小长度 上传消息处理函数
    {(uint32_t)0XFFFFFFFF     ,2 ,SrvMsgIpcStepMotor5Upload_PlaceHolder},
};


//IPC上传消息处理函数
void SrvMsgIpcStepMotor5Upload(void* ipcMsgBodyPtr)
{
    ...
    //搜索匹配处理器
    uint16_t indexStepMotor5 = 0;
    for(indexStepMotor5 = 0; indexStepMotor5 < DIM_ARRAY_ELEMENT_COUNT(ipcStepMotor5MsgUploadProcUnitArray);indexStepMotor5++)
    {
        if(ipcUploadDataPtr->uploadID == (uint32_t)(ipcStepMotor5MsgUploadProcUnitArray[indexStepMotor5].uploadId))
        {
            break;
        }
    }
    //判定序号
    if(indexStepMotor5 == DIM_ARRAY_ELEMENT_COUNT(ipcStepMotor5MsgUploadProcUnitArray))
    {
        //不支持的指令
    ...
    //判定长度
    if(ipcUploadDataPtr->dataLength < ipcStepMotor5MsgUploadProcUnitArray[indexStepMotor5].exceptParamLengthMin)
    {
        //小于最小指令预期长度
        SystemPrintf("E:> %s,%d,Recv ExceptMinParamLength:%d ,Real: %d,UploadID: 0X%08X\r\n",__func__,__LINE__,
                        ipcStepMotor5MsgUploadProcUnitArray[indexStepMotor5].exceptParamLengthMin,ipcUploadDataPtr->dataLength,
    ...
    //检测函数指针
    if(ipcStepMotor5MsgUploadProcUnitArray[indexStepMotor5].ipcUploadProcFuncPtr == NULL)
    {
    ...
    //调用指令处理
    ipcStepMotor5MsgUploadProcUnitArray[indexStepMotor5].ipcUploadProcFuncPtr(ipcUploadDataPtr);
    //处理完成,释放内存
    if((ipcUploadDataPtr->dataBufferPtr != NULL)&&(ipcUploadDataPtr->dataLength != 0))
    {
        UserMemFree(MEM_REGION_SYS_MSG_IPC,ipcUploadDataPtr->dataBufferPtr);
