...
** LastEditTime  : 2023-11-06 10:45:11 +0800
************************************************************************************************/ 
#ifndef __DRIVER_CONFIG_TIMER_H__
#define __DRIVER_CONFIG_TIMER_H__
...
//是否执行TIMER6测试用例
#define MCU_TIMER6_TEST_CASE_USE                            CONFIG_FUNC_DISABLE
//是否打印定时器中断讯息
