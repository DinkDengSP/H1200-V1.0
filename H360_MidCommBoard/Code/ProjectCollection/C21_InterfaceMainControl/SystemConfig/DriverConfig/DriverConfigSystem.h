...
//CAN消息使用的内存空间         
#define MEM_REGION_SYS_MSG_CAN                                          MEM_SDRAM1
//UART消息使用的内存空间
...
//系统参数内存
#define MEM_REGION_SYSTEM_PARAM                                         MEM_SDRAM1
//系统状态内存
#define MEM_REGION_SYSTEM_STATE                                         MEM_SDRAM1
//服务层任务使用的内存空间          
#define MEM_REGION_SRV_TASK                                             MEM_AXI_SRAM
//模块层任务使用的内存空间          
#define MEM_REGION_MOD_TASK                                             MEM_SDRAM1
//应用层任务使用的内存空间          
#define MEM_REGION_APP_TASK                                             MEM_SDRAM2
//日志文件包含讯息          
...
/*----------------------------------------UART宏定义相关----------------------------------------*/
#define PROT_UART_USER_LH_LOCAL                                         CONFIG_FUNC_DISABLE

/*--------------------------------------SDCARD文件系统---------------------------------------------*/
#define FILE_X_SDCARD_ALLOC_MEM_REGION                                  MEM_SDRAM1
//文件系统动态内存长            
#define FILE_X_SDCARD_ALLOC_MEM_LENGTH                                  512*1024
//容错系统使用的动态内存长度            
#define FILE_X_SDCARD_ALLOC_TOLERANT_MEM_LENGTH                         512*1024
//SDCARD FLASH文件系统名称         
#define NAME_FILEX_SDCARD                                               "StorageSDCard"
//SDCARD是否使用EXFAT
#define FILE_X_SDCARD_USE_EXFAT                                         CONFIG_FUNC_DISABLE
...
//LAN8700是否开启文件传输功能                           
#define NETX_FILE_FTP_SERVICE_MODE                                      CONFIG_FUNC_ENABLE
...
//探针通讯端口服务器缓存                    
#define TCP_LAN8700_PROBE_SOCKET_BUF_LENGTH                             (63*1024)
//是否使能探针通讯端口日志信息打印
#define TCP_LAN8700_PROBE_RECV_MSG_SHOW_BUF                             CONFIG_FUNC_DISABLE
//探针通讯端口号                    
#define TCP_LAN8700_PROBE_SOCKET_PORT                                   19900
//探针端口可以连接的设备总数                    
#define TCP_LAN8700_PROBE_SOCKET_PORT_MAX_CLIENT                        1
...
/*----------------------------------------NETX W5500 驱动层基础定义----------------------------------------*/
//NETX使用的动态内存空间
#define NETX_W5500_MEM_REGION                                         MEM_SDRAM1
//NETX驱动调试任务使能              
#define NETX_W5500_DRIVER_DEBUG_SHOW                                  CONFIG_FUNC_DISABLE
//是否显示收发缓存              
#define NETX_W5500_DRIVER_DEBUG_SHOW_BUF                              CONFIG_FUNC_DISABLE
//W5500协议栈缓存             
#define NETX_W5500_PACKET_POOL_SIZE                                   (1*1024*1024)
//1522的ETH帧加上12个字节的IP包头               
#define NETX_W5500_PACKET_SIZE                                        1536
//W5500 IP协议的ARP缓存列表长度               
#define NX_W5500_ARP_LENGTH                                           1024
//周期性读取网卡数据的周期                  
#define TIME_MS_PERIOD_W5500_READ_DATA                                20

/********************************************IP W5500 SOCKET实例状态机*******************************/
//主通讯端口服务器缓存
#define TCP_W5500_MAIN_SOCKET_BUF_LENGTH                              (63*1024)
//是否使能主通讯端口日志信息打印
#define TCP_W5500_MAIN_RECV_MSG_SHOW_BUF                              CONFIG_FUNC_DISABLE
//主通讯端口号                  
...
//探针通讯端口服务器缓存                    
#define TCP_W5500_PROBE_SOCKET_BUF_LENGTH                             (63*1024)
//是否使能探针通讯端口日志信息打印
#define TCP_W5500_PROBE_RECV_MSG_SHOW_BUF                             CONFIG_FUNC_DISABLE
//探针通讯端口号                    
#define TCP_W5500_PROBE_SOCKET_PORT                                   19900
//探针端口可以连接的设备总数                    
#define TCP_W5500_PROBE_SOCKET_PORT_MAX_CLIENT                        1

//日志通讯端口服务器缓存                    
#define TCP_W5500_LOG_SOCKET_BUF_LENGTH                               (63*1024)
//是否使能日志通讯端口日志信息打印
#define TCP_W5500_LOG_RECV_MSG_SHOW_BUF                               CONFIG_FUNC_DISABLE
//日志通讯端口号                    
