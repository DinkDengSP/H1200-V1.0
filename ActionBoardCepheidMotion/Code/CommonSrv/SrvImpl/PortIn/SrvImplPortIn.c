...
//CAN1指令消息处理函数
extern void SrvMsgCan1PortInCmd(void* canMsgBodyPtr);
//CAN1上传消息处理函数
extern void SrvMsgCan1PortInUpload(void* canMsgBodyPtr);
//CAN2指令消息处理函数
extern void SrvMsgCan2PortInCmd(void* canMsgBodyPtr);
//CAN2上传消息处理函数
extern void SrvMsgCan2PortInUpload(void* canMsgBodyPtr);
//IPC指令消息处理函数
extern void SrvMsgIpcPortInCmd(void* ipcMsgBodyPtr);
//IPC上传消息处理函数
extern void SrvMsgIpcPortInUpload(void* ipcMsgBodyPtr);
