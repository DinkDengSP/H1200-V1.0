...
const STEP_MOTOR_ATTRIBUTE StepMotor11DefaultAttri = {
    ...
    //基础配置
    {
        ...
        200,//float resetSpeedFast;复位速度,快速,主要用在找原点
        50,//float resetSpeedSlow;复位速度,慢速,主要用在脱离原点和二次回到原点
