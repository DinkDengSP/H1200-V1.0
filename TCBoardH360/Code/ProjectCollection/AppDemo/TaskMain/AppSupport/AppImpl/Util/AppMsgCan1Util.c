...
static const USER_CAN_CMD_PROC_UNIT can1CmdProcUtilUnitArray[] = 
{
    ...
    {CAN_MASTER_CMD_PLACE_HOLDER          ,1  ,ENABLE ,AppMsgCan1UtilCmd_PlaceHolder    },
};


//CAN指令消息处理函数
void AppMsgCan1UtilCmd(void* canMsgBodyPtr)
{
    //转换指令码
...
/*************************************************************CAN上传参数处理***********************************************************/
//占位函数
static void AppMsgCan1UtilUpload_PlaceHolder(CAN_PROT_UPLOAD_PACK* canUploadPackRecvPtr);
...
//CAN上传消息处理函数
void AppMsgCan1UtilUpload(void* canMsgBodyPtr)
{
