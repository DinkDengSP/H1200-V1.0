...
//任务的控制块
TX_THREAD tcbModTaskMeasureModule;
//任务堆栈
uint64_t stackBufferModTaskMeasureModule[STK_SIZE_MOD_TASK_MEASURE_MODULE/8];
//任务消息队列控制块
TX_QUEUE queueModTaskMeasureModule@".ccram";
//消息缓冲区
uint32_t queueBufferModTaskMeasureModule[LENGTH_QUEUE_MOD_TASK_MEASURE_MODULE];
