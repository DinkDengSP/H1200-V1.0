...
//SPI1中断,使用DMA模式的时候的优先级      
#define SPI1_PREE_PRI_DMA                           NVIC_INT_PRE_PRI_2
#define SPI1_SUB_PRI_DMA                            NVIC_INT_SUB_PRI_1

//SPI1 DMA发送中断
#define SPI1_DMA_TX_PREE_PRI                        NVIC_INT_PRE_PRI_2
#define SPI1_DMA_TX_SUB_PRI                         NVIC_INT_SUB_PRI_2

//SPI1 DMA接收中断  
#define SPI1_DMA_RX_PREE_PRI                        NVIC_INT_PRE_PRI_2
#define SPI1_DMA_RX_SUB_PRI                         NVIC_INT_SUB_PRI_2
...
//ADC1采样中断
#define ADC1_PREE_PRI                               NVIC_INT_PRE_PRI_3
#define ADC1_SUB_PRI                                NVIC_INT_SUB_PRI_3

//ADC1_DMA
#define ADC1_DMA_PREE_PRI                           NVIC_INT_PRE_PRI_3
#define ADC1_DMA_SUB_PRI                            NVIC_INT_SUB_PRI_3
