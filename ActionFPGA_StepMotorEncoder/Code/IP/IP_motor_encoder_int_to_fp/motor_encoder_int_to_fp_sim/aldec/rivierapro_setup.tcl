...
# ACDS 22.1 917 win32 2024.01.22.10:27:00
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     motor_encoder_int_to_fp
# 
...
# ----------------------------------------
# If motor_encoder_int_to_fp is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "motor_encoder_int_to_fp"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/motor_encoder_int_to_fp.vo"
}
