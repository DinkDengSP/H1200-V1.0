...
/*************************************************************IPC指令处理处理***********************************************************/
//通讯测试
static void SrvMsgIpcStepMotor3Cmd_CommTest(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机复位
static void SrvMsgIpcStepMotor3Cmd_Reset(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机走步数
static void SrvMsgIpcStepMotor3Cmd_RunStep(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机走坐标
static void SrvMsgIpcStepMotor3Cmd_RunCoordinate(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机回零
static void SrvMsgIpcStepMotor3Cmd_ReturnZero(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机持续运转
static void SrvMsgIpcStepMotor3Cmd_RunAlways(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机立即停止
static void SrvMsgIpcStepMotor3Cmd_StopNow(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机减速停止
static void SrvMsgIpcStepMotor3Cmd_StopSlowDown(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//获取电机当前坐标
static void SrvMsgIpcStepMotor3Cmd_GetCoordinate(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//获取当前原点传感器状态
static void SrvMsgIpcStepMotor3Cmd_ReadOriginSensor(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机失能
static void SrvMsgIpcStepMotor3Cmd_Disable(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机进入教学模式
static void SrvMsgIpcStepMotor3Cmd_EnterTeachMode(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);
//电机强行进入默认状态
static void SrvMsgIpcStepMotor3Cmd_ForceToDefault(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr);

//IPC指令处理函数列表
static const USER_IPC_CMD_PROC_UNIT ipcStepMotor3MsgCmdProcUnitArray[] = 
{
    //顺序是 指令码 预期参数最小长度  指令处理函数
    {(uint32_t)0XFFFFFFFF     ,0    ,SrvMsgIpcStepMotor3Cmd_CommTest  },
    {(uint32_t)0X00000000     ,0    ,SrvMsgIpcStepMotor3Cmd_Reset               },
    {(uint32_t)0X00000001     ,0    ,SrvMsgIpcStepMotor3Cmd_RunStep             },
    {(uint32_t)0X00000002     ,0    ,SrvMsgIpcStepMotor3Cmd_RunCoordinate       },
    {(uint32_t)0X00000003     ,0    ,SrvMsgIpcStepMotor3Cmd_ReturnZero          },
    {(uint32_t)0X00000004     ,0    ,SrvMsgIpcStepMotor3Cmd_RunAlways           },
    {(uint32_t)0X00000005     ,0    ,SrvMsgIpcStepMotor3Cmd_StopNow             },
    {(uint32_t)0X00000006     ,0    ,SrvMsgIpcStepMotor3Cmd_StopSlowDown        },
    {(uint32_t)0X00000007     ,0    ,SrvMsgIpcStepMotor3Cmd_GetCoordinate       },
    {(uint32_t)0X00000008     ,0    ,SrvMsgIpcStepMotor3Cmd_ReadOriginSensor    },
    {(uint32_t)0X00000009     ,0    ,SrvMsgIpcStepMotor3Cmd_Disable             },
    {(uint32_t)0X0000000A     ,0    ,SrvMsgIpcStepMotor3Cmd_EnterTeachMode      },
    {(uint32_t)0X0000000B     ,0    ,SrvMsgIpcStepMotor3Cmd_ForceToDefault      },
};


//IPC指令消息处理函数
void SrvMsgIpcStepMotor3Cmd(void* ipcMsgBodyPtr)
{
    //转换指令码
    ...
    //搜索匹配处理器
    uint16_t indexStepMotor3 = 0;
    for(indexStepMotor3 = 0; indexStepMotor3 < DIM_ARRAY_ELEMENT_COUNT(ipcStepMotor3MsgCmdProcUnitArray);indexStepMotor3++)
    {
        if(ipcCmdMsgPtr->cmdBaseData.commandCode == (uint32_t)(ipcStepMotor3MsgCmdProcUnitArray[indexStepMotor3].commandCode))
        {
            break;
        }
    }
    //判定序号
    if(indexStepMotor3 == DIM_ARRAY_ELEMENT_COUNT(ipcStepMotor3MsgCmdProcUnitArray))
    {
        //不支持的指令
    ...
    //判定长度
    if(ipcCmdMsgPtr->cmdBaseData.cmdParamBufferLength < ipcStepMotor3MsgCmdProcUnitArray[indexStepMotor3].exceptParamLengthMin)
    {
        //小于最小指令预期长度
        SystemPrintf("E:> %s,%d,Recv ExceptMinParamLength:%d ,Real: %d,CommandCode: 0X%08X\r\n",__func__,__LINE__,
                        ipcStepMotor3MsgCmdProcUnitArray[indexStepMotor3].exceptParamLengthMin,ipcCmdMsgPtr->cmdBaseData.cmdParamBufferLength,
    ...
    //检测函数指针
    if(ipcStepMotor3MsgCmdProcUnitArray[indexStepMotor3].ipcCmdProcFuncPtr == NULL)
    {
    ...
    //调用处理函数
    ipcStepMotor3MsgCmdProcUnitArray[indexStepMotor3].ipcCmdProcFuncPtr(&(ipcCmdMsgPtr->cmdBaseData),&sysResultPack,ipcCmdMsgPtr->channelCachePtr);
    //处理完成回传
...
static void SrvMsgIpcStepMotor3Cmd_Reset(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor3Reset(&stepMotorResetCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
...
static void SrvMsgIpcStepMotor3Cmd_RunStep(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor3RunStep(&runStepCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_RunCoordinate(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor3RunCoordinate(&runCoordinateCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_ReturnZero(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor3ReturnZero(&returnZeroCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_RunAlways(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor3RunAlways(&runAlwaysCmd,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_StopNow(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor3StopNow(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_StopSlowDown(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API
    SrvImplBaseStepMotor3StopSlowDown(slowDownMode,slowDownSteps,timeOutMs,resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_GetCoordinate(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor3GetCoordinate(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_ReadOriginSensor(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor3ReadOriginSensor(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_Disable(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor3Disable(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_EnterTeachMode(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor3EnterTeachMode(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
static void SrvMsgIpcStepMotor3Cmd_ForceToDefault(IPC_CMD_BASE_DATA* ipcCmdMsgPtr,SYS_RESULT_PACK* resultPackPtr,IPC_CHANNEL_CACHE* channelCachePtr)
{
    ...
    channelCachePtr->returnDataBufferLength = 0;
    //调用API实现
    SrvImplBaseStepMotor3ForceToDefault(resultPackPtr,&returnBufferPtr,&returnBufferLength);
    //对结果进行处理
    if(resultPackPtr->resultCode == PROT_RESULT_SUCCESS)
    {
        if((returnBufferPtr != NULL)&&(returnBufferLength != 0))
...
/*************************************************************IPC上报讯息处理**********************************************************/
//占位函数
static void SrvMsgIpcStepMotor3Upload_PlaceHolder(IPC_UPLOAD_DATA* ipcUploadDataPtr);

//IPC上传消息处理函数列表
static const USER_IPC_UPLOAD_PROC_UNIT ipcStepMotor3MsgUploadProcUnitArray[] = 
{
    //顺序是: 指令码 预期参数最小长度 上传消息处理函数
    {(uint32_t)0XFFFFFFFF     ,2 ,SrvMsgIpcStepMotor3Upload_PlaceHolder},
};


//IPC上传消息处理函数
void SrvMsgIpcStepMotor3Upload(void* ipcMsgBodyPtr)
{
    ...
    //搜索匹配处理器
    uint16_t indexStepMotor3 = 0;
    for(indexStepMotor3 = 0; indexStepMotor3 < DIM_ARRAY_ELEMENT_COUNT(ipcStepMotor3MsgUploadProcUnitArray);indexStepMotor3++)
    {
        if(ipcUploadDataPtr->uploadID == (uint32_t)(ipcStepMotor3MsgUploadProcUnitArray[indexStepMotor3].uploadId))
        {
            break;
        }
    }
    //判定序号
    if(indexStepMotor3 == DIM_ARRAY_ELEMENT_COUNT(ipcStepMotor3MsgUploadProcUnitArray))
    {
        //不支持的指令
    ...
    //判定长度
    if(ipcUploadDataPtr->dataLength < ipcStepMotor3MsgUploadProcUnitArray[indexStepMotor3].exceptParamLengthMin)
    {
        //小于最小指令预期长度
        SystemPrintf("E:> %s,%d,Recv ExceptMinParamLength:%d ,Real: %d,UploadID: 0X%08X\r\n",__func__,__LINE__,
                        ipcStepMotor3MsgUploadProcUnitArray[indexStepMotor3].exceptParamLengthMin,ipcUploadDataPtr->dataLength,
    ...
    //检测函数指针
    if(ipcStepMotor3MsgUploadProcUnitArray[indexStepMotor3].ipcUploadProcFuncPtr == NULL)
    {
    ...
    //调用指令处理
    ipcStepMotor3MsgUploadProcUnitArray[indexStepMotor3].ipcUploadProcFuncPtr(ipcUploadDataPtr);
    //处理完成,释放内存
    if((ipcUploadDataPtr->dataBufferPtr != NULL)&&(ipcUploadDataPtr->dataLength != 0))
    {
        UserMemFree(MEM_REGION_SYS_MSG_IPC,ipcUploadDataPtr->dataBufferPtr);
