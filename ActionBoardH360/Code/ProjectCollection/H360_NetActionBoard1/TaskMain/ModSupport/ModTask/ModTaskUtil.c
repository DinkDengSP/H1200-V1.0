...
** LastEditTime  : 2023-11-26 22:54:14 +0800
************************************************************************************************/ 
#include "TaskConfigMod.h"
#include "ModImplUtil.h"

//任务的控制块
TX_THREAD tcbModTaskUtil;
//任务堆栈
uint64_t stackBufferModTaskUtil[STK_SIZE_MOD_TASK_UTIL/8];
//任务消息队列控制块
TX_QUEUE queueModTaskUtil@".ccram";
//消息缓冲区
uint32_t queueBufferModTaskUtil[LENGTH_QUEUE_MOD_TASK_UTIL];
