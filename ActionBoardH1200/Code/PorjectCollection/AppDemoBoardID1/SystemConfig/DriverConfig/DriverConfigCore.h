...
//中断向量偏移
#define VECTOR_TABLE_OFFSET_ADDR                        0X40000
//中断向量表长度            
...
//PLL2时钟设置,PLL2M,HSE Frequency(Hz)= 24000000,设置输出6M
#define CLK_PLL2_M_PARAM                                4
//锁相环倍频系数,倍频160,输出960M
#define CLK_PLL2_N_PARAM                                160
//PLL2P,480M,输出供给CLK_OUT2,LPTIM2,LPTIM234,ADC,SAI4AB,SPI123,LPTIM1,SAI1,SAI2
#define CLK_PLL2_P_PARAM                                2
//PLL2Q,480M.输出供给FDCAN,SPI6,LPUART1,UART234578,SPI45,USART16
#define CLK_PLL2_Q_PARAM                                2
//PLL2R,240M,输出供给SDMMC1,QSPI,FMC,SPDIF
