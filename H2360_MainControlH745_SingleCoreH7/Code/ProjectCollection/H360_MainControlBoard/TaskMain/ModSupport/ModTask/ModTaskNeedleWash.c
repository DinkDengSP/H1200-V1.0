...
//任务的控制块
TX_THREAD tcbModTaskNeedleWash@".dtcm_ram";
//任务堆栈
uint64_t stackBufferModTaskNeedleWash[STK_SIZE_MOD_TASK_NEEDLE_WASH/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueModTaskNeedleWash@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferModTaskNeedleWash[LENGTH_QUEUE_MOD_TASK_NEEDLE_WASH]@".dtcm_ram";
