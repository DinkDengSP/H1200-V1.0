...
#elif(MCU_LOG_SHOW_MODE_USER == MCU_LOG_SHOW_MODE_UART2)
//使用RTT进行底层输出,包含相关文件
#include "MCU_UART2.h"
#define MCU_LogSendBuffer(bufPtr,bufLen)       MCU_UART2_SendBuffer(bufPtr,bufLen)
#define MCU_LogSendString(stringPtr)           MCU_UART2_SendString(stringPtr)
#define MCU_LogSendStringInt(stringPtr)        MCU_UART2_SendStringInt(stringPtr)
#define MCU_LogPrintf(format, ...)             MCU_UART2_Printf(format, ##__VA_ARGS__)
#define MCU_LogShowErrorSubCode(subCode)       MCU_UART2_Printf("Func : %s,Line : %d,ErrorSubCode :0X%08X\r\n",__FUNCTION__,__LINE__,subCode)
#define MCU_LogShowHalState(state,errorCode)   MCU_UART2_Printf("Func : %s,Line : %d,HalResult : 0X%02X,,HalErrorCode: 0X%08X\r\n",__FUNCTION__,__LINE__,state,errorCode)
#define MCU_LogShowGetLock()                   MCU_UART2_GetLock()
#define MCU_LogShowReleaseLock()               MCU_UART2_ReleaseLock()

#elif(MCU_LOG_SHOW_MODE_USER == MCU_LOG_SHOW_MODE_UART3)
//使用RTT进行底层输出,包含相关文件
#include "MCU_UART3.h"
#define MCU_LogSendBuffer(bufPtr,bufLen)       MCU_UART3_SendBuffer(bufPtr,bufLen)
#define MCU_LogSendString(stringPtr)           MCU_UART3_SendString(stringPtr)
#define MCU_LogSendStringInt(stringPtr)        MCU_UART3_SendStringInt(stringPtr)
#define MCU_LogPrintf(format, ...)             MCU_UART3_Printf(format, ##__VA_ARGS__)
#define MCU_LogShowErrorSubCode(subCode)       MCU_UART3_Printf("Func : %s,Line : %d,ErrorSubCode :0X%08X\r\n",__FUNCTION__,__LINE__,subCode)
#define MCU_LogShowHalState(state,errorCode)   MCU_UART3_Printf("Func : %s,Line : %d,HalResult : 0X%02X,,HalErrorCode: 0X%08X\r\n",__FUNCTION__,__LINE__,state,errorCode)
#define MCU_LogShowGetLock()                   MCU_UART3_GetLock()
#define MCU_LogShowReleaseLock()               MCU_UART3_ReleaseLock()
