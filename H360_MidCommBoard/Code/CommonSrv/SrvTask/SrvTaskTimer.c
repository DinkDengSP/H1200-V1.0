...
//任务的控制块
TX_THREAD tcbSrvTaskTimer@".dtcm_ram";
//任务堆栈
uint64_t stackBufferSrvTaskTimer[STK_SIZE_SRV_TASK_TIMER/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueSrvTaskTimer@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferSrvTaskTimer[LENGTH_QUEUE_SRV_TASK_TIMER]@".dtcm_ram";
