...
//任务的控制块
TX_THREAD tcbModTaskHandNewCup@".dtcm_ram";
//任务堆栈
uint64_t stackBufferModTaskHandNewCup[STK_SIZE_MOD_TASK_HAND_NEW_CUP/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueModTaskHandNewCup@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferModTaskHandNewCup[LENGTH_QUEUE_MOD_TASK_HAND_NEW_CUP]@".dtcm_ram";
