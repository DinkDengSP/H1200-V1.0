...
//任务的控制块
TX_THREAD tcbModTaskCupTrayManage@".dtcm_ram";
//任务堆栈
uint64_t stackBufferModTaskCupTrayManage[STK_SIZE_MOD_TASK_CUP_TRAY_MANAGE/8]@".dtcm_ram";
//任务消息队列控制块
TX_QUEUE queueModTaskCupTrayManage@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferModTaskCupTrayManage[LENGTH_QUEUE_MOD_TASK_CUP_TRAY_MANAGE]@".dtcm_ram";
