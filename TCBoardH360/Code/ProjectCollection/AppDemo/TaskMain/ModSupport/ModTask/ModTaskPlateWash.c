...
//任务的控制块
TX_THREAD tcbModTaskPlateWash@".ccram";
//任务堆栈
uint64_t stackBufferModTaskPlateWash[STK_SIZE_MOD_TASK_PLATE_WASH/8]@".ccram";
//任务消息队列控制块
TX_QUEUE queueModTaskPlateWash@".dtcm_ram";
//消息缓冲区
uint32_t queueBufferModTaskPlateWash[LENGTH_QUEUE_MOD_TASK_PLATE_WASH]@".ccram";
