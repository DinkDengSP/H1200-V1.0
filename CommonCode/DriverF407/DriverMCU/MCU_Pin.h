...
** LastEditTime  : 2023-10-31 19:26:57 +0800
************************************************************************************************/ 
#ifndef __MCU_PIN_H_
#define __MCU_PIN_H_
...
//系统传感器相关
typedef struct MCU_SENSOR_CONFIG
{
    uint8_t externSensorIndex;  //导出外部使用的传感器序号
    uint8_t innerSensorIndex;   //驱动内部使用的传感器序号
    GPIO_PinState validPinState;//传感器有效的电平值
}MCU_SENSOR_CONFIG;
...
//清除中断配置
void MCU_PinExtiClearConfig(MCU_PIN pin);
