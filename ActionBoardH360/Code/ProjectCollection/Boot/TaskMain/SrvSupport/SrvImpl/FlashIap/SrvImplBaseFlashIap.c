...
** LastEditTime  : 2024-01-03 09:02:59 +0800
************************************************************************************************/ 
                                    ...
                                    uint8_t** dataBufPtrPtr,uint16_t* dataBufLen)
{
    ...
    if(boardIapFileInfo.boardIapMode == BOARD_IAP_MODE_SRV)
    {
        ...
        do
        {
            ...
            //写入完成,进行比对
            flashCompare = MCU_FlashCompare(MCU_FLASH_APP+boardIapFileInfo.recordRecvFileByteCount,(uint8_t*)writeBufferPtrAlign4Byte,
