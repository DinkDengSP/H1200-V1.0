 ...
 ** description  : 
 ** LastEditors  : 邓小俊
 ** LastEditTime : 2024-02-05 13:14:42
...
#define SPI5_DMA_TX_INSTANCE                            DMA2_Stream0
#define SPI5_DMA_TX_PRIORITY                            DMA_PRIORITY_MEDIUM
#define SPI5_DMA_TX_IRQ                                 DMA2_Stream0_IRQn
#define SPI5_DMA_TX_IRQ_HANDLER                         DMA2_Stream0_IRQHandler
//DMA接收配置映射
#define SPI5_DMA_RX_CLK_ENABLE()                        __HAL_RCC_DMA2_CLK_ENABLE()
#define SPI5_DMA_RX_INSTANCE                            DMA2_Stream1
#define SPI5_DMA_RX_PRIORITY                            DMA_PRIORITY_MEDIUM
#define SPI5_DMA_RX_IRQ                                 DMA2_Stream1_IRQn
#define SPI5_DMA_RX_IRQ_HANDLER                         DMA2_Stream1_IRQHandler
#endif
